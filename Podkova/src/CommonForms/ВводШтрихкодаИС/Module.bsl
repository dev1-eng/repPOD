...
Процедура ПроверитьФорматШтрихкода()
	...
	РезультатРаспаковки = ШтрихкодированиеИСКлиентСервер.Base64ВШтрихкод(ШтрихкодДляПроверки);
	Если РезультатРаспаковки <> ШтрихкодДляПроверки Тогда
		РезультатРазбора = РазборКодаМаркировкиИССлужебныйКлиент.РазобратьКодМаркировки(
			РезультатРаспаковки, Неопределено, ПримечаниеКРезультатуРазбора);
	КонецЕсли;
