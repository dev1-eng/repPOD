...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Параметры.Свойство("ВыбиратьОперандПлана", ВыбиратьОперандПлана);
...
Процедура ДеревоОперандовВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(СтрокаРодитель.Идентификатор)
		И Не ВыбиратьОперандПлана Тогда
...
Процедура ОК(Команда)
	...
	Если РаботаСФормуламиКлиент.ПроверитьФормулу(Формула, ОперандыФормулы(),
...
Процедура Проверить(Команда)
	...
	ОчиститьСообщения();
	РаботаСФормуламиКлиент.ПроверитьФормулуИнтерактивно(Формула, ОперандыФормулы(), "Формула", СтроковаяФормула, ПараметрыПроверкиФормулы(ЭтаФорма));
...
Функция ОперандыФормулы()
	...
	ИначеЕсли ИспользуетсяДеревоОперандов Тогда
		...
		МассивОперандов = РаботаСФормуламиКлиентСервер.МассивОперандовДляДерева(ДеревоОперандов, ВыбиратьОперандПлана);
...
Функция  ОбработатьТекстОперанда(ТекстОперанда)
	...
	// Проверка на наличии "." в имени операнда дополнительного реквизита
...
Процедура ДобавитьВДеревоСтроки(Данные, СтрокаРодитель)
	...
	ДочерниеЭлементы = СтрокаРодитель.ПолучитьЭлементы();
...
Функция ПараметрыПроверкиФормулы(Форма)
	...
	ДополнительныеПараметры.Вставить("ВыбиратьОперандПлана", Форма.ВыбиратьОперандПлана);
