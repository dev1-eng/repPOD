...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗаполнитьНадписиКратностиВалют();
...
Процедура ЗаполнитьСписокКурсовВалют(ИзмененаВалюта=Ложь)
	...
	ИначеЕсли ЗначениеЗаполнено(ВалютаДокумента) И ЗначениеЗаполнено(ВалютаВзаиморасчетов) Тогда
		...
		КурсВалютыВзаиморасчетовНаДату = РаботаСКурсамиВалют.ПолучитьКурсВалюты(ВалютаВзаиморасчетов, ДатаДокумента);
		...
		Для ДеньМинус = 1 По 5 Цикл
			...
			КурсВалютыВзаиморасчетовНаДату = РаботаСКурсамиВалют.ПолучитьКурсВалюты(ВалютаВзаиморасчетов, ДатаКурса);
			КурсПересчета = РаботаСКурсамиВалютУТ.ПолучитьКроссКурсВалют(КурсВалютыДокументаНаДату,КурсВалютыВзаиморасчетовНаДату);
...
Процедура УстановитьВидимостьЭлементов()
	...
	Элементы.КратностьВалютыВзаиморасчетовНадпись.Видимость = (ВидимостьКурсаВзаиморасчетов И КратностьВалютыВзаиморасчетов <> 1);
	...
	Элементы.КратностьВалютыДокументаНадпись.Видимость      = (ВидимостьКурсаДокумента И КратностьВалютыДокумента <> 1);
...
&НаСервере
Процедура ЗаполнитьНадписиКратностиВалют()
	
	КратностьВалютыВзаиморасчетовНадпись =
		СтрШаблон("%1 за %2 %3", ВалютаДокумента, КратностьВалютыВзаиморасчетов, ВалютаВзаиморасчетов);
	КратностьВалютыДокументаНадпись =
		СтрШаблон("%1 за %2 %3", ВалютаВзаиморасчетов, КратностьВалютыДокумента, ВалютаДокумента);
