...
Процедура ЗаполнитьТаблицуТоварыНакладной(Накладная)
	...
	Запрос.УстановитьПараметр("ТоварыПоЗаказам",        ?(НастройкиОтборов = Неопределено, Неопределено, НастройкиОтборов.ТаблицаОтборов));
	...
	Если НастройкиФормы.ЭтоДокументПоступлениеТоваров Тогда
...
Функция ТекстЗапросаТоваровНакладной(ЕстьОтборПоСкладу, ЕстьОтборПоТоварам, ЕстьОтборПоТоварамЗаказа)
	...
	ТекстЗапроса = 
		...
		+ ТекстЗапросаОтборПоТоварамЗаказа
		+ "ВЫБРАТЬ РАЗРЕШЕННЫЕ
		...
		|
		|СГРУППИРОВАТЬ ПО
		|	Таблица.Номенклатура, Таблица.Характеристика, Таблица.Серия, Таблица.Склад
		|
		|ИНДЕКСИРОВАТЬ ПО
		|	Номенклатура, Характеристика, Серия, Склад
		|;
		|
		|////////////////////////////////////////////////////////////////////////
	...
	Если ЕстьОтборПоТоварамЗаказа Тогда
		...
		ОтборТоварыКОтгрузке         = "(ДокументОтгрузки, Номенклатура, Характеристика) В
									   |			(ВЫБРАТЬ
		...
		ТоварыКОформлениюПоступления = "(ДокументПоступления, Номенклатура, Характеристика) В
									   |			(ВЫБРАТЬ
									   |				ВтТаблицаОтборовПоТоварамЗаказа.Заказ,
									   |				ВтТаблицаОтборовПоТоварамЗаказа.Номенклатура,
									   |				ВтТаблицаОтборовПоТоварамЗаказа.Характеристика
...
Функция НакладныеПоЗаказам(Заказы)
	...
	|ГДЕ
	|	Таблица.Активность
	|	//ОтборПоЗаказам_И Таблица.ДокументОтгрузки В(&Заказы)
	|	//ОтборПоТоварам_И (Таблица.ДокументОтгрузки, Таблица.Номенклатура, Таблица.Характеристика) В
	|	//ОтборПоТоварам_		(ВЫБРАТЬ
	|	//ОтборПоТоварам_			ВтТаблицаОтборовПоТоварамЗаказа.Заказ,
	|	//ОтборПоТоварам_			ВтТаблицаОтборовПоТоварамЗаказа.Номенклатура,
	|	//ОтборПоТоварам_			ВтТаблицаОтборовПоТоварамЗаказа.Характеристика
	|	//ОтборПоТоварам_		ИЗ
	|	//ОтборПоТоварам_			ВтТаблицаОтборовПоТоварамЗаказа)
	...
	|ГДЕ
	|	Таблица.Активность
	|	//ОтборПоЗаказам_И Таблица.ДокументПоступления В(&Заказы)
	|	//ОтборПоТоварам_И (Таблица.ДокументПоступления, Таблица.Номенклатура, Таблица.Характеристика) В
	|	//ОтборПоТоварам_		(ВЫБРАТЬ
	|	//ОтборПоТоварам_			ВтТаблицаОтборовПоТоварамЗаказа.Заказ,
	|	//ОтборПоТоварам_			ВтТаблицаОтборовПоТоварамЗаказа.Номенклатура,
	|	//ОтборПоТоварам_			ВтТаблицаОтборовПоТоварамЗаказа.Характеристика
	...
	Если НастройкиОтборов = Неопределено Тогда
		ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "//ОтборПоЗаказам_", "");
	Иначе	
		...
		ТекстыЗапросов.Добавить(СтрЗаменить(ТекстЗапроса, "//ОтборПоТоварам_", ""));
	...
	Запрос.УстановитьПараметр("Заказы", ?(НастройкиОтборов = Неопределено, Заказы, НастройкиОтборов.ТаблицаОтборов));
	Запрос.УстановитьПараметр("Склад", Склады.ВыгрузитьЗначения());
