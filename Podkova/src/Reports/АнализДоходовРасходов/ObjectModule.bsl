...
Функция ТекстЗапросаРасходы()
	...
	|	ПрочиеРасходы.ПериодГод КАК ПериодГод,
	|
	|	ПрочиеРасходы.СтоимостьРеглНачальныйОстаток КАК СуммаНачальныйОстаток,
	|	ПрочиеРасходы.СтоимостьРеглПриход КАК СуммаПриход,
	|	0 КАК СуммаРасход,
	|	ПрочиеРасходы.СтоимостьРеглКонечныйОстаток КАК СуммаКонечныйОстаток
	|ИЗ
	|	РегистрНакопления.ПартииПрочихРасходов.ОстаткиИОбороты(, , Авто, , 
	|		СтатьяРасходов.ВариантРаспределенияРасходовРегл = ЗНАЧЕНИЕ(Перечисление.ВариантыРаспределенияРасходов.НаСебестоимостьТоваров)
	|		И &ДанныеОтчета = 4
	...
	|	0 КАК СуммаНачальныйОстаток,
	|	0 КАК СуммаПриход,
	|	ПрочиеРасходы.СтоимостьРегл КАК СуммаРасход,
	|	0 КАК СуммаКонечныйОстаток
	|ИЗ
	|	РегистрНакопления.ПартииПрочихРасходов КАК ПрочиеРасходы
	|ГДЕ
