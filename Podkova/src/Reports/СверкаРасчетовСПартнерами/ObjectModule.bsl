...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	ДанныеДокумента = Документы.СверкаВзаиморасчетов.ВыборкаДанныхДокументаНаПечать(СверкиВзаиморасчетов);
		...
		Если ТаблицаОстатковРасчетов <> Неопределено Тогда
			Для Каждого СтрокаЗадолженности Из ТаблицаОстатковРасчетов Цикл
				...
				Если ДанныеДокумента.РасшифровкаПоЗаказам Тогда
					СтрокаДанныеОрганизации.РасчетныйДокумент = Документы.СверкаВзаиморасчетов.УстаревшееОписаниеРасчетногоДокумента(
...
Функция СверкиВзаиморасчетовОтчета()
	...
	ПараметрКомпоновки = НастройкиКомпоновкиДанных.ПараметрыДанных.Элементы.Найти("ЗапрещенныеТипыРасчетов");
	...
	Если ТаблицаСверокВзаиморасчетов.Колонки.Найти("СверкаВзаиморасчетов") <> Неопределено Тогда
