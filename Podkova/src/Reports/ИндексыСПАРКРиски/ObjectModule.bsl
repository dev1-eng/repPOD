...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	Иначе
		...
		ПараметрПрекратилДейтельность = Новый ПараметрКомпоновкиДанных("КонтрагентПрекратилДеятельность");
		Для Каждого ТекущийПараметрДанных Из НастройкиОтчета.ПараметрыДанных.Элементы Цикл
			Если ТекущийПараметрДанных.Параметр = ПараметрПрекратилДейтельность Тогда
