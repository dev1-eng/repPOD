...
Функция ТекстЗапросаВременнойТаблицы(ВыводитьТоварыВПути, ВыводитьНеотфактурованныеПоставки)
	...
	Если ВыводитьНеотфактурованныеПоставки Тогда
		Условия.Добавить("АналитикаУчетаНоменклатуры.Договор.ВариантОформленияЗакупок = ЗНАЧЕНИЕ(Перечисление.ВариантыОформленияЗакупок.НеотфактурованныеПоставки)");
	КонецЕсли;
