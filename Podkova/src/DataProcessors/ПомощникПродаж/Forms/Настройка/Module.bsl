...
Процедура УстановитьДоступностьВариантОбеспечения(Форма)
	...
	ЭтоЗаказРеализация = Форма.ВариантОформленияДокументов = ПредопределенноеЗначение("Перечисление.ВариантыОформленияДокументовПродажи.ЗаказКлиентаРеализацияТоваровУслуг");
	
	Если ЭтоЗаказРеализация
		И Форма.УпрощенноеОбеспечение
		И Форма.ВариантОбеспечения <> ПредопределенноеЗначение("Перечисление.ВариантыОбеспечения.Отгрузить") Тогда
		Форма.ВариантОбеспечения = ПредопределенноеЗначение("Перечисление.ВариантыОбеспечения.Отгрузить");
	КонецЕсли;
	
	ОбработатьИзменениеФлага(Форма.УпрощенноеОбеспечение И Не ЭтоЗаказРеализация, Форма.Элементы.ВариантОбеспечения);
...
Процедура ИнициализироватьВариантыОформленияДокументовПродажи()
	...
	ИспользоватьПередачуТоваровХранение = Ложь;
