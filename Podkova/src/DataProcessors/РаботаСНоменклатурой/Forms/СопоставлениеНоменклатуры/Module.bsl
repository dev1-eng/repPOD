...
Функция ДанныеДляЗаписиВРегистрСоответствия(НоменклатураИХарактеристики, ЕстьДублиИдентификаторов = Ложь, ЕстьСтрокиБезНоменклатуры = Ложь)
	...
	// являются разными объектами и нельзя использовать агригирующие функции сразу на два поля.
...
&НаКлиенте
Процедура ПослеЗакрытияФормыСпискаВидаНоменклатуры(Результат, ДополнительныеПараметры) Экспорт
