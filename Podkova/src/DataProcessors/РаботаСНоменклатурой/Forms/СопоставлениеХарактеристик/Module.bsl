...
Процедура ЗаполнитьХарактеристикиНоменклатуры()
	...
	ХарактеристикиИнформационнойБазы.ПроизвольныйЗапрос = Истина;
	ХарактеристикиИнформационнойБазы.ТекстЗапроса       = ТекстЗапроса;
	ХарактеристикиИнформационнойБазы.ОсновнаяТаблица    = 
...
Процедура ЗаполнитьПодсказкиФормы()
	...
	Элементы.ПояснениеКОперации.Заголовок
