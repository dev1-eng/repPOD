...
Функция КонтактнаяИнформация()
	...
	КонтактнаяИнформация.Вставить("КонтактноеЛицо", "Контактное лицо");
	КонтактнаяИнформация.Вставить("Должность", "Должность");
	КонтактнаяИнформация.Вставить("Email", "Email");
