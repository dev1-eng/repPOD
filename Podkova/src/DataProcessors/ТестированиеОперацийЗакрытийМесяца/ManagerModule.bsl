...
Функция СоответствиеКонтрольныхРегистров(ВыбранныеРазделы = Неопределено) Экспорт
	...
	Если ВыбранныеРазделы.Найти("ВзаиморасчетыСПартнерами") <> Неопределено Тогда // Взаиморасчеты
		Если ПолучитьФункциональнуюОпцию("НоваяАрхитектураВзаиморасчетов") Тогда
			РегистрыКонтроля.Вставить(Метаданные.РегистрыНакопления.РасчетыСКлиентамиПоСрокам.ПолноеИмя(), "ВзаиморасчетыСПартнерами");
			РегистрыКонтроля.Вставить(Метаданные.РегистрыНакопления.РасчетыСПоставщикамиПоСрокам.ПолноеИмя(), "ВзаиморасчетыСПартнерами");
			РегистрыКонтроля.Вставить(Метаданные.РегистрыНакопления.РасчетыСКлиентамиПланОплат.ПолноеИмя(), "ВзаиморасчетыСПартнерами");
			РегистрыКонтроля.Вставить(Метаданные.РегистрыНакопления.РасчетыСКлиентамиПланОтгрузок.ПолноеИмя(), "ВзаиморасчетыСПартнерами");
			РегистрыКонтроля.Вставить(Метаданные.РегистрыНакопления.РасчетыСПоставщикамиПланОплат.ПолноеИмя(), "ВзаиморасчетыСПартнерами");
			РегистрыКонтроля.Вставить(Метаданные.РегистрыНакопления.РасчетыСПоставщикамиПланПоставок.ПолноеИмя(), "ВзаиморасчетыСПартнерами");
		Иначе
...
Функция ТестироватьЗаПериод(ПараметрыОбработки)
	...
	Для каждого ЭтапТестирования Из ПараметрыОбработки.ЭтапыТестирования Цикл
		...
		КонецЕсли;
		ПараметрыСравненияДанных.Вставить("ИсключаемыеПоля", Новый Структура("ИдентификаторФинЗаписи"));
