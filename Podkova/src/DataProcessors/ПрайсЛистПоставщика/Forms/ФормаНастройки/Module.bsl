...
Процедура ПодборНоменклатурыПартнера(Команда)
	...
	СопоставлениеНоменклатурыКонтрагентовКлиент.ОткрытьФормуВыбораНоменклатурыКонтрагентов(ПараметрыФормы, Элементы.ТаблицаНоменклатурыПартнера);
...
Процедура ИнициализироватьДеревоИерархииНоменклатурыПартнера()
	...
	Дерево = РеквизитФормыВЗначение("ДеревоИерархииНоменклатурыПартнера", Тип("ДеревоЗначений"));
