...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИнициализироватьНастройкиНСИ(2, "Справочник.ДоговорыКонтрагентов");
	ИнициализироватьНастройкиНСИ(3, "Справочник.ДоговорыМеждуОрганизациями");
	
	КомпоновщикиНастроек[3].Пометка = ПолучитьФункциональнуюОпцию("ИспользоватьДоговорыМеждуОрганизациями");
	Элементы.ДоговорыМеждуОрганизациями.Видимость = КомпоновщикиНастроек[3].Пометка;
	
	Элементы.ДоговорыЛизинга.Видимость = Ложь;
