...
Функция РезультатЗапросаСертификатов(ИдентификаторЭДО = Неопределено) Экспорт
	...
	|		КОНЕЦ
	|	И Сертификаты.Сертификат.Пользователь В (&Пользователи)
	|ИТОГИ ПО
	|	ИдентификаторЭДО";
	...
	ПользователиСертификата.Добавить(Справочники.Пользователи.ПустаяСсылка());
	ПользователиСертификата.Добавить(Пользователи.СсылкаНеуказанногоПользователя());
	
	Запрос.УстановитьПараметр("Пользователи", ПользователиСертификата);
