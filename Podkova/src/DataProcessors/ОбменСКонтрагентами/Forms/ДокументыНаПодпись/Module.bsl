...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ОбменСКонтрагентамиСлужебный.ЕстьПравоПодписанияЭД(Истина) Тогда
		Отказ = Истина;
	КонецЕсли;
...
Процедура ЗаполнитьСводнуюТаблицу(ТаблицаДоступныхСертификатов)
	...
	Если ЗначениеЗаполнено(ВидДокумента) Тогда
		...
		ИначеЕсли ТипЗнч(ВидДокумента) = Тип("СправочникСсылка.ВидыВнутреннихДокументовЭДО") Тогда
			СтруктураДопОтбора.Вставить("ВидВнутреннегоДокумента", ВидДокумента);
			ЗапросПоДокументам.УстановитьПараметр("ВидВнутреннегоДокумента", ВидДокумента); 
		КонецЕсли;
	КонецЕсли;
