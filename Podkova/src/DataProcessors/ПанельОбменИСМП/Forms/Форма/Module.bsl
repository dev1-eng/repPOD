...
&НаКлиенте
Процедура ОткрытьШаблоныЭтикетокСУЗ(Команда)
	
	ОткрытьФорму("Справочник.ШаблоныЭтикетокСУЗ.Форма.ФормаСписка");
...
Процедура ВключитьЛогированиеЗапросов(ПродолжительностьВМинутах)
	...
	ЛогированиеЗапросовИСМП.ВключитьЛогированиеЗапросов(ПродолжительностьВМинутах * 60);
...
Процедура ОчиститьЛогЗапросов()
	...
	ЛогированиеЗапросовИСМП.ОчиститьЛогЗапросов();
	ПараметрыЛогирования = ПолучитьПараметрыЛогирования();
...
Функция ПолучитьПараметрыЛогирования()
	...
	ПараметрыЛогирования.Включено = ЛогированиеЗапросовИСМП.ВыполняетсяЛогированиеЗапросов(ПараметрыЛогирования);
...
Процедура ОбработкаНавигационнойСсылкиЛогирования(Элемент, НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка)
	...
	ИначеЕсли НавигационнаяСсылкаФорматированнойСтроки = "ОткрытьЛогЗапросов" Тогда
		...
		ЛогированиеЗапросовИСМПКлиент.ОткрытьПросмотрЛогаЗапросов(УникальныйИдентификатор);
