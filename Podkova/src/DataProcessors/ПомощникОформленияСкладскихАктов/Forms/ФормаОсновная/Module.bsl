...
&НаКлиенте
Процедура ОтобратьПоТипуОперацииНачалоВыбораЗавершение(Знач Результат, Знач ДополнительныеПараметры) Экспорт
	...
	Иначе
		ОтобратьПоТипуОперации.ЗагрузитьЗначения(Результат);
