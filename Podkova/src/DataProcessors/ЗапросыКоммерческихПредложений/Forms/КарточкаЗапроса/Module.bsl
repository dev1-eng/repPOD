...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("КодВалютыДокумента") И Параметры.КодВалютыДокумента <> ""
		...
		ВалютаДокумента = ЭлектронноеВзаимодействие.НайтиСсылку("Валюты", Параметры.КодВалютыДокумента);
	Иначе
		ВалютаДокумента = ЭлектронноеВзаимодействие.НайтиСсылку("Валюты", Параметры.КодВалюты);
	КонецЕсли;
...
Процедура ЗаполнитьНаОснованииДерева(ДанныеВходящегоДокумента)
	...
	Валюта = ЭлектронноеВзаимодействие.НайтиСсылку("Валюты",
	...
	Для Каждого СведенияОТоваре Из СведенияОТоварах.Строки Цикл
		...
		НоваяСтрока.ЕдиницаИзмеренияПредставление = ЭлектронноеВзаимодействие.ЗначениеРеквизитаВДереве(СведенияОТоваре,
