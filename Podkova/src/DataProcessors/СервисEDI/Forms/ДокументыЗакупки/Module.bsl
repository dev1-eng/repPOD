...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = "Запись_ЗаказПоставщику"
		...
		ОбработатьОповещениОЗаписиДокументаЖурнала();
...
Процедура ОрганизацияПриИзменении(Элемент)
	...
	ПриИзменениОтбораПоОрганизацииСервер();
...
Процедура СтатусСоответствияПриИзменении(Элемент)
	...
	ПриИзменениОтбораПоСтатусуСоответствия();
...
&НаСервере
Процедура ОбработатьОповещениОЗаписиДокументаЖурнала()
...
&НаКлиенте
Процедура ПлановаяДатаПослеВыбора(Результат, ДополнительныеПарамаетры) Экспорт
...
&НаСервере
Процедура ПриИзменениОтбораПоОрганизацииСервер()
...
&НаСервере
Процедура ПриИзменениОтбораПоСтатусуСоответствия()
