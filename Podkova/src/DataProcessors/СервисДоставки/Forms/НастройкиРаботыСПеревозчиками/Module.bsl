...
Процедура ОрганизацияПриИзменении(Элемент)
	...
	Если ЗначениеЗаполнено(Организация) Тогда
		...
		Если Отказ Тогда
			...
			ТекстВопроса =
			СтрШаблон(НСтр("ru = 'Организация %1 не зарегистрирована в Бизнес-Сети. Зарегистрировать?'"), Организация);
...
Процедура ТребуетсяАвторизация(Команда)
	...
	ОткрытьФорму("Обработка.СервисДоставки.Форма.АвторизацияВЛКГрузоперевозчика", ПараметрыФормы, ЭтотОбъект);
КонецПроцедуры
