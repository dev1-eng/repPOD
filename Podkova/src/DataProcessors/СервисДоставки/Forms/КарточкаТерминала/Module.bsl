...
Процедура НастроитьФормуПоТипуГрузоперевозки();
	...
	Если ТипГрузоперевозки = 1 Тогда
		Заголовок = НСтр("ru = '1С:Доставка: Пункт приема-выдачи'");
	Иначе
		Заголовок = НСтр("ru = '1С:Курьер: Пункт приема-выдачи'");
	КонецЕсли;
	...
	Если ЭтоАдресВременногоХранилища(АдресРезультата) Тогда
		...
		Если ЗначениеЗаполнено(Результат) 
			...
			Если Результат.Свойство("Данные") Тогда
				...
				Если ТипГрузоперевозки = 1 Тогда
					ТексЗаголовка = НСтр("ru='1С:Доставка: %1 (%2)'");
				Иначе
					ТексЗаголовка = НСтр("ru='1С:Курьер: %1 (%2)'");
				КонецЕсли;
				
				Заголовок = СтрШаблон(ТексЗаголовка, Наименование, ТипНаименование);
			Иначе
