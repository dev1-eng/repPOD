...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если НастройкиИспользованияСерий.ИспользоватьСрокГодностиСерии Тогда
		...
		Если НастройкиИспользованияСерий.ТочностьУказанияСрокаГодностиСерии = Перечисления.ТочностиУказанияСрокаГодности.СТочностьюДоМесяцев Тогда
			Элементы.СерииГоденДо.Заголовок = НСтр("ru = 'Годен до (месяц, год)'");
			Элементы.ОстаткиСерийГоденДо.Заголовок = НСтр("ru = 'Годен до (месяц, год)'");
		ИначеЕсли НастройкиИспользованияСерий.ТочностьУказанияСрокаГодностиСерии = Перечисления.ТочностиУказанияСрокаГодности.СТочностьюДоДней Тогда
	...
	Если НастройкиИспользованияСерий.ИспользоватьДатуПроизводстваСерии Тогда
		...
		Если НастройкиИспользованияСерий.ТочностьУказанияСрокаГодностиСерии = Перечисления.ТочностиУказанияСрокаГодности.СТочностьюДоМесяцев Тогда
			Элементы.СерииДатаПроизводства.Заголовок = НСтр("ru = 'Дата производства (месяц, год)'");
			Элементы.ОстаткиСерийДатаПроизводства.Заголовок = НСтр("ru = 'Дата производства (месяц, год)'");
		ИначеЕсли НастройкиИспользованияСерий.ТочностьУказанияСрокаГодностиСерии = Перечисления.ТочностиУказанияСрокаГодности.СТочностьюДоДней Тогда
	...
	Элементы.СерииПроизводительВЕТИС.Видимость           = НастройкиИспользованияСерий.ИспользоватьПроизводителяВЕТИССерии;
	Элементы.СерииЗаписьСкладскогоЖурналаВЕТИС.Видимость = НастройкиИспользованияСерий.ИспользоватьЗаписьСкладскогоЖурналаВЕТИССерии;
	Элементы.СерииИдентификаторПартииВЕТИС.Видимость     = НастройкиИспользованияСерий.ИспользоватьИдентификаторПартииВЕТИССерии;
	
	Элементы.СерииМаксимальнаяРозничнаяЦенаМОТП.Видимость = НастройкиИспользованияСерий.ИспользоватьМРЦМОТПСерии;
	...
	Элементы.ОстаткиСерийПроизводительВЕТИС.Видимость           = НастройкиИспользованияСерий.ИспользоватьПроизводителяВЕТИССерии;
	Элементы.ОстаткиСерийЗаписьСкладскогоЖурналаВЕТИС.Видимость = НастройкиИспользованияСерий.ИспользоватьЗаписьСкладскогоЖурналаВЕТИССерии;
	Элементы.ОстаткиСерийИдентификаторПартииВЕТИС.Видимость     = НастройкиИспользованияСерий.ИспользоватьИдентификаторПартииВЕТИССерии;
	
	Элементы.ОстаткиСерийМаксимальнаяРозничнаяЦенаМОТП.Видимость = НастройкиИспользованияСерий.ИспользоватьМРЦМОТПСерии;
...
Функция ТекстЗапросаРеквизитыСерий(ИмяТаблицы)
	...
	|	ВЫРАЗИТЬ(ТаблицаСерий.Серия КАК Справочник.СерииНоменклатуры).ПроизводительВЕТИС КАК ПроизводительВЕТИС,
	|	ВЫРАЗИТЬ(ТаблицаСерий.Серия КАК Справочник.СерииНоменклатуры).ЗаписьСкладскогоЖурналаВЕТИС КАК ЗаписьСкладскогоЖурналаВЕТИС,
	|	ВЫРАЗИТЬ(ТаблицаСерий.Серия КАК Справочник.СерииНоменклатуры).ИдентификаторПартииВЕТИС КАК ИдентификаторПартииВЕТИС,
	|	ВЫРАЗИТЬ(ТаблицаСерий.Серия КАК Справочник.СерииНоменклатуры).МаксимальнаяРозничнаяЦенаМОТП КАК МаксимальнаяРозничнаяЦенаМОТП,
...
Процедура СерииНомерПриИзменении(Элемент)
	...
	ПодобратьСерию(Элемент, "Номер","ГоденДо,НомерКиЗГИСМ,ДатаПроизводства,ПроизводительЕГАИС,Справка2ЕГАИС,
		|ПроизводительВЕТИС,ЗаписьСкладскогоЖурналаВЕТИС,ИдентификаторПартииВЕТИС,МаксимальнаяРозничнаяЦенаМОТП");
	...
	Если Не ОтменаРедактирования Тогда
		...
		Если Не НастройкиИспользованияСерий.ИспользоватьКоличествоСерии Тогда
			...
			Если ЗначениеЗаполнено(ТекущиеДанные.Номер)
				...
				Или ЗначениеЗаполнено(ТекущиеДанные.Справка2ЕГАИС)
				Или ЗначениеЗаполнено(ТекущиеДанные.ПроизводительВЕТИС)
				Или ЗначениеЗаполнено(ТекущиеДанные.ИдентификаторПартииВЕТИС)
				Или ЗначениеЗаполнено(ТекущиеДанные.ЗаписьСкладскогоЖурналаВЕТИС)
				Или ЗначениеЗаполнено(ТекущиеДанные.МаксимальнаяРозничнаяЦенаМОТП) Тогда
		...
		СтруктураПараметров.Вставить("ПроизводительВЕТИС",Элементы.Серии.ТекущиеДанные.ПроизводительВЕТИС);
		СтруктураПараметров.Вставить("ЗаписьСкладскогоЖурналаВЕТИС",Элементы.Серии.ТекущиеДанные.ЗаписьСкладскогоЖурналаВЕТИС);
		СтруктураПараметров.Вставить("ИдентификаторПартииВЕТИС",Элементы.Серии.ТекущиеДанные.ИдентификаторПартииВЕТИС);
		СтруктураПараметров.Вставить("МаксимальнаяРозничнаяЦенаМОТП",Элементы.Серии.ТекущиеДанные.МаксимальнаяРозничнаяЦенаМОТП);
...
&НаКлиенте
Процедура СерииПроизводительВЕТИСПриИзменении(Элемент)
	
	ТекущиеДанные = Элементы.Серии.ТекущиеДанные;
	
	Если ЗначениеЗаполнено(ТекущиеДанные.ПроизводительВЕТИС) Тогда
		ПодобратьСерию(Элемент,"ПроизводительВЕТИС","ГоденДо,Номер,НомерКиЗГИСМ,ДатаПроизводства,ПроизводительЕГАИС,
			|Справка2ЕГАИС,ЗаписьСкладскогоЖурналаВЕТИС,ИдентификаторПартииВЕТИС,МаксимальнаяРозничнаяЦенаМОТП");
	Иначе
		ТекущиеДанные.Серия = Неопределено;
	КонецЕсли;
...
&НаКлиенте
Процедура СерииИдентификаторПартииВЕТИСПриИзменении(Элемент)
	ТекущиеДанные = Элементы.Серии.ТекущиеДанные;
	
	Если ЗначениеЗаполнено(ТекущиеДанные.ИдентификаторПартииВЕТИС) Тогда
		ПодобратьСерию(Элемент,"ИдентификаторПартииВЕТИС","ГоденДо,Номер,НомерКиЗГИСМ,ДатаПроизводства,ПроизводительЕГАИС,
			|Справка2ЕГАИС,ПроизводительВЕТИС,ЗаписьСкладскогоЖурналаВЕТИС,МаксимальнаяРозничнаяЦенаМОТП");
	Иначе
		ТекущиеДанные.Серия = Неопределено;
	КонецЕсли;
КонецПроцедуры
...
&НаКлиенте
Процедура СерииМаксимальнаяРозничнаяЦенаМОТППриИзменении(Элемент)
	ТекущиеДанные = Элементы.Серии.ТекущиеДанные;
	
	Если ЗначениеЗаполнено(ТекущиеДанные.МаксимальнаяРозничнаяЦенаМОТП) Тогда
		ПодобратьСерию(Элемент,"МаксимальнаяРозничнаяЦенаМОТП","ГоденДо,Номер,НомерКиЗГИСМ,ДатаПроизводства,ПроизводительЕГАИС,
			|Справка2ЕГАИС,ПроизводительВЕТИС,ЗаписьСкладскогоЖурналаВЕТИС,ИдентификаторПартииВЕТИС");
	Иначе
		ТекущиеДанные.Серия = Неопределено;
	КонецЕсли;
КонецПроцедуры
...
&НаКлиенте
Процедура СерииЗаписьСкладскогоЖурналаВЕТИСПриИзменении(Элемент)
	
	ТекущиеДанные = Элементы.Серии.ТекущиеДанные;
	
	Если ЗначениеЗаполнено(ТекущиеДанные.ЗаписьСкладскогоЖурналаВЕТИС) Тогда
		ПодобратьСерию(Элемент,"ЗаписьСкладскогоЖурналаВЕТИС","ГоденДо,Номер,НомерКиЗГИСМ,ДатаПроизводства,ПроизводительЕГАИС,
			|Справка2ЕГАИС,ПроизводительВЕТИС,ИдентификаторПартииВЕТИС,МаксимальнаяРозничнаяЦенаМОТП");
	Иначе
		ТекущиеДанные.Серия = Неопределено;
	КонецЕсли;
	...
	Если ШтрихкодыПоТипам.БезТипа.Количество() > 0 Тогда
		...
		Если Не ЕстьОшибки Тогда
			...
			Пока Выборка.Следующий() Цикл
				...
				СтруктураПоиска = Новый Структура("Серия, Номер, ГоденДо, ДатаПроизводства, ПроизводительЕГАИС,
													|Справка2ЕГАИС, ИдентификаторПартииВЕТИС,
													|ЗаписьСкладскогоЖурналаВЕТИС, МаксимальнаяРозничнаяЦенаМОТП");
				
				ЗаполнитьЗначенияСвойств(СтруктураПоиска, Выборка);
				
				СтруктураПоиска.ИдентификаторПартииВЕТИС		= ?(ЗначениеЗаполнено(Выборка.ИдентификаторПартииВЕТИС),
																	Выборка.ИдентификаторПартииВЕТИС,
																	Метаданные.ОпределяемыеТипы.СтрокаВЕТИС.Тип.ПривестиЗначение());
				СтруктураПоиска.МаксимальнаяРозничнаяЦенаМОТП	= ?(ЗначениеЗаполнено(Выборка.МаксимальнаяРозничнаяЦенаМОТП),
																	Выборка.МаксимальнаяРозничнаяЦенаМОТП,
...
Функция СохранитьСериюПоСтроке(СтрТаблИдентификатор)
	...
	Если ПравоДобавленияСерий Тогда
		...
		Если Не ЗначениеЗаполнено(СтрТабл.Серия) Тогда
			...
			СправочникОбъект.ПроизводительВЕТИС = СтрТабл.ПроизводительВЕТИС;
			СправочникОбъект.ЗаписьСкладскогоЖурналаВЕТИС  = СтрТабл.ЗаписьСкладскогоЖурналаВЕТИС;
			СправочникОбъект.ИдентификаторПартииВЕТИС      = СтрТабл.ИдентификаторПартииВЕТИС;
			СправочникОбъект.МаксимальнаяРозничнаяЦенаМОТП = СтрТабл.МаксимальнаяРозничнаяЦенаМОТП;
...
Процедура ПодобратьСерию(Элемент,ВводимыйРеквизит,ПроверяемыеРеквизиты)
	...
	Значение.Вставить("ПроизводительВЕТИС",ТекущиеДанные.ПроизводительВЕТИС);
	Значение.Вставить("ИдентификаторПартииВЕТИС",ТекущиеДанные.ИдентификаторПартииВЕТИС);
	Значение.Вставить("ЗаписьСкладскогоЖурналаВЕТИС",ТекущиеДанные.ЗаписьСкладскогоЖурналаВЕТИС);
	Значение.Вставить("МаксимальнаяРозничнаяЦенаМОТП",ТекущиеДанные.МаксимальнаяРозничнаяЦенаМОТП);
	...
	ИначеЕсли СписокВыбора.Количество() = 2 Тогда
		Если СокрЛП(СписокВыбора[0].Значение.Номер) <> СокрЛП(СписокВыбора[1].Значение.Номер)
			...
			Или (СписокВыбора[0].Значение.Справка2ЕГАИС <> СписокВыбора[1].Значение.Справка2ЕГАИС
				И ЗначениеЗаполнено(СписокВыбора[0].Значение.Справка2ЕГАИС))
			Или (СписокВыбора[0].Значение.ПроизводительВЕТИС <> СписокВыбора[1].Значение.ПроизводительВЕТИС
				И ЗначениеЗаполнено(СписокВыбора[0].Значение.ПроизводительВЕТИС))
			Или (СписокВыбора[0].Значение.ЗаписьСкладскогоЖурналаВЕТИС <> СписокВыбора[1].Значение.ЗаписьСкладскогоЖурналаВЕТИС
				И ЗначениеЗаполнено(СписокВыбора[0].Значение.ЗаписьСкладскогоЖурналаВЕТИС)) 
			Или (СписокВыбора[0].Значение.ИдентификаторПартииВЕТИС <> СписокВыбора[1].Значение.ИдентификаторПартииВЕТИС
				И ЗначениеЗаполнено(СписокВыбора[0].Значение.ИдентификаторПартииВЕТИС))
			Или (СписокВыбора[0].Значение.МаксимальнаяРозничнаяЦенаМОТП <> СписокВыбора[1].Значение.МаксимальнаяРозничнаяЦенаМОТП
				И ЗначениеЗаполнено(СписокВыбора[0].Значение.МаксимальнаяРозничнаяЦенаМОТП)) Тогда
	...
	Для Каждого Строка Из Объект.Серии Цикл
		...
		Если ((НастройкиИспользованияСерий.ИспользоватьНомерКИЗГИСМСерии
				...
				Или (Не НастройкиИспользованияСерий.ИспользоватьНомерКИЗГИСМСерии
					...
					И Строка.ПроизводительВЕТИС = СтруктураПараметров.ПроизводительВЕТИС
					И Строка.ЗаписьСкладскогоЖурналаВЕТИС = СтруктураПараметров.ЗаписьСкладскогоЖурналаВЕТИС
					И Строка.ИдентификаторПартииВЕТИС = СтруктураПараметров.ИдентификаторПартииВЕТИС
					И Строка.МаксимальнаяРозничнаяЦенаМОТП = СтруктураПараметров.МаксимальнаяРозничнаяЦенаМОТП))
...
Процедура НайтиЗарегистрированныеСерии()
	...
	|	Серии.ПроизводительВЕТИС КАК ПроизводительВЕТИС,
	|	Серии.ПроизводительВЕТИС = ЗНАЧЕНИЕ(Справочник.ПредприятияВЕТИС.ПустаяСсылка) КАК ПроизводительВЕТИСНеУказан,
	|	Серии.ЗаписьСкладскогоЖурналаВЕТИС КАК ЗаписьСкладскогоЖурналаВЕТИС,
	|	Серии.ЗаписьСкладскогоЖурналаВЕТИС = ЗНАЧЕНИЕ(Справочник.ЗаписиСкладскогоЖурналаВЕТИС.ПустаяСсылка) КАК ЗаписьСкладскогоЖурналаВЕТИСНеУказан,
	|	Серии.ИдентификаторПартииВЕТИС КАК ИдентификаторПартииВЕТИС,
	|	Серии.ИдентификаторПартииВЕТИС = """" КАК ИдентификаторПартииВЕТИСНеУказан,
	|	Серии.МаксимальнаяРозничнаяЦенаМОТП КАК МаксимальнаяРозничнаяЦенаМОТП,
	|	Серии.МаксимальнаяРозничнаяЦенаМОТП = 0 КАК МаксимальнаяРозничнаяЦенаМОТПНеУказан,
	...
	|						КОНЕЦ
	|						И ВЫБОР
	|							КОГДА СерииНоменклатуры.ВидНоменклатуры.ИспользоватьПроизводителяВЕТИССерии
	|								ТОГДА Серии.ПроизводительВЕТИС = СерииНоменклатуры.ПроизводительВЕТИС
	|							ИНАЧЕ Серии.ПроизводительВЕТИСНеУказан
	|						КОНЕЦ
	|						И ВЫБОР
	|							КОГДА СерииНоменклатуры.ВидНоменклатуры.ИспользоватьЗаписьСкладскогоЖурналаВЕТИССерии
	|								ТОГДА Серии.ЗаписьСкладскогоЖурналаВЕТИС = СерииНоменклатуры.ЗаписьСкладскогоЖурналаВЕТИС
	|							ИНАЧЕ Серии.ЗаписьСкладскогоЖурналаВЕТИСНеУказан
	|						КОНЕЦ
	|						И ВЫБОР
	|							КОГДА СерииНоменклатуры.ВидНоменклатуры.ИспользоватьИдентификаторПартииВЕТИССерии
	|								ТОГДА Серии.ИдентификаторПартииВЕТИС = СерииНоменклатуры.ИдентификаторПартииВЕТИС
	|							ИНАЧЕ Серии.ИдентификаторПартииВЕТИСНеУказан
	|						КОНЕЦ
	|						И ВЫБОР
	|							КОГДА СерииНоменклатуры.ВидНоменклатуры.ИспользоватьМРЦМОТПСерии
	|								ТОГДА Серии.МаксимальнаяРозничнаяЦенаМОТП = СерииНоменклатуры.МаксимальнаяРозничнаяЦенаМОТП
	|							ИНАЧЕ Серии.МаксимальнаяРозничнаяЦенаМОТПНеУказан
	|						КОНЕЦ
	|			КОНЕЦ)
	|ГДЕ
