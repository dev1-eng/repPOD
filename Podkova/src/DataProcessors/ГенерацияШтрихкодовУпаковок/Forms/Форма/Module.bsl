...
Процедура УправлениеФормой(Форма)
	...
	ИначеЕсли Форма.ТипШтрихкодаСтрокой = "SSCC" Тогда
		...
		Если Форма.РежимУказанияПараметровГенерации Тогда
			...
			Элементы.ГруппаРеквизитыSSCCЗапомнитьПараметрыГенерации.Видимость = Истина;
		КонецЕсли;
...
Процедура ТипШтрихкодаСтрокойПриИзмененииСервер()
	...
	ТипШтрихкода = ШтрихкодированиеИСКлиентСервер.ТипШтрихкодаПоСтроке(ТипШтрихкодаСтрокой);
