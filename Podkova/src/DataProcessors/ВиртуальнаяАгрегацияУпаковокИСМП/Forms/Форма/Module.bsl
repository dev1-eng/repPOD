...
Процедура СгенерироватьСерии(Команда)
	...
	Если Не ПроверкаИПодборПродукцииИСМПКлиентСервер.ТребуетсяУказаниеСерий(СоставУпаковки)
		И Не ПроверкаИПодборПродукцииИСМПКлиентСервер.СериюМожноУказать(СоставУпаковки) Тогда
