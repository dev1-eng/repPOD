...
//  Организация                       - Произвольный - данные об организаии документа.
//
&НаСервере
...
Функция ПредставлениеДокумента(Документ)
	...
	Возврат СтрШаблон(НСтр("ru = '%1 №%2 от %3'"), МетаданныеДокумента.ПредставлениеОбъекта, ДанныеДокумента.Номер,
