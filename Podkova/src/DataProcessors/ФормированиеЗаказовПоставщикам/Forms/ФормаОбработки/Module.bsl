...
Процедура ПередЗакрытием(Отказ, ЗавершениеРаботы, ТекстПредупреждения, СтандартнаяОбработка)
	...
	НеобходимоРазмещениеЗаказов = РазместитьВЗаказахПоставщику
		И НепоставленныеВГрафикДокументыКоличество < СформированныеЗаказы.Количество();
...
Процедура ЗаполнитьТаблицы(УдалятьДокументы = Истина)
	...
	ИначеЕсли РазместитьВЗаказахПоставщику И НепоставленныеВГрафикДокументыКоличество < СформированныеЗаказы.Количество() Тогда
...
Процедура ОбновитьИтогиПоСозданнымДокументам()
	...
	Если СформированныеЗаказы.Количество() > 0 Тогда
		...
		Запрос = Новый Запрос();
		Запрос.УстановитьПараметр("СозданныеДокументы", СформированныеЗаказы.ВыгрузитьЗначения());
		Запрос.Текст =
		"ВЫБРАТЬ
		|
