...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ДеревоОтсканированнойУпаковкиИндексКартинкиШтрихкод.КартинкаЗначений =
		ПроверкаИПодборПродукцииИС.КартинкаТипыУпаковкиПоВидуПродукции(ВидПродукции);
...
Процедура ПоказатьИнформациюОПроблемахСТабачнойПродукцией(ИнформацияВДереве)
	...
	Если ИнформацияВДереве Тогда
		...
		Иначе
			...
			ВидУпаковки       = ДанныеТабачнойПродукции.ВидУпаковки;
			ТипШтрихкода      = ДанныеТабачнойПродукции.ТипШтрихкода;
	...
	ИначеЕсли ЗначениеЗаполнено(ТабачнаяПродукция) Тогда
	...
	СоставСтроки.Добавить(Новый ФорматированнаяСтрока(
		Префикс, " ", СтрокаШтриховойКод, " ", НСтр("ru = 'по причине:'"), " ", Символы.ПС, ТекстСОшибкой));
	...
	Элементы.ДекорацияОшибкаДобавленияТабачнойПродукции.Заголовок = Новый ФорматированнаяСтрока(СоставСтроки);
