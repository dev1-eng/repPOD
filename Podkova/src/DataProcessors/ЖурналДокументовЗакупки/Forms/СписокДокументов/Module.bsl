...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ТЗХозОперацииИТипыДокументов = Обработки.ЖурналДокументовЗакупки.ИнициализироватьХозяйственныеОперацииИДокументы(
	...
	БизнесСеть.ПодключитьОповещениеОНовыхДокументахВСервисе(ЭтотОбъект, 
		ЭлектронноеВзаимодействиеУТ.ВидыЭДПоИмениОбъекта(ЭтотОбъект.СписокДокументыЗакупки.ОсновнаяТаблица));
