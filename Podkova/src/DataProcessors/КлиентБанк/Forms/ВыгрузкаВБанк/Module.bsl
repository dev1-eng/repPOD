...
Процедура Выгрузить(Команда)
	...
	ПодключитьОбработчикОжидания("Подключаемый_ОбработатьЗавершениеВыгрузки", 1, Истина);
...
&НаКлиенте
Процедура Подключаемый_ОбработатьЗавершениеВыгрузки()
...
&НаКлиенте
Процедура ОбработатьЗавершениеВыгрузки(ЕстьНеобходимостьОбновленияСпискаПлатежей = Ложь)
...
Процедура ВыгрузитьФайлНаКлиентеЗавершение(ПолученныеФайлы, ДополнительныеПараметры) Экспорт
	...
	ОбработатьЗавершениеВыгрузки(Истина);
