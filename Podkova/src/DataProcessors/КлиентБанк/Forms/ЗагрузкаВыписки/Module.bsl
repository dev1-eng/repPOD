		...
		Если Выписки.Строки.Количество() Тогда
			...
			Если СтрокаНомерСчета <> Неопределено Тогда
				...
				Если СчетаВыписки.Количество() Тогда
					...
					СтрокаСчета.АдресХранилищаФайла = ПоместитьВоВременноеХранилище(ДеревоВыписки, ЭтаФорма.УникальныйИдентификатор);
				КонецЕсли;
			КонецЕсли;
		КонецЕсли;
	КонецЕсли;
