...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ИнтеграцияС1СДокументооборотПовтИсп.ДоступенФункционалВерсииСервиса("2.1.16.2.CORP") Тогда
...
Процедура ЗаполнитьФормуЗадачи(Параметры)
	...
	Элементы.НовыйСрок.ТолькоПросмотр = Не ДоступноВыполнение;
...
Процедура УстановитьДоступностьКомандДереваПриложений()
	...
	Иначе
		...
		Элементы.ФормаУдалитьПредмет.Доступность = ТекущиеДанные.ДоступноУдаление;
	КонецЕсли;
