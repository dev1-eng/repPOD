...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Запрос = Новый Запрос(
		"ВЫБРАТЬ
		|	ТипОбъектаИС КАК ТипОбъекта,
		|	ВЫРАЗИТЬ(ПредставлениеОбъектаИС КАК СТРОКА(100)) КАК Вариант,
		...
		|ПО Правила.Ссылка = КлючевыеРеквизиты.Ссылка И КлючевыеРеквизиты.Ключевой И Не КлючевыеРеквизиты.ЭтоДополнительныйРеквизитИС
		|ГДЕ
		|	НЕ ПометкаУдаления
		|УПОРЯДОЧИТЬ ПО
		|	Вариант
