...
Процедура Подключаемый_ПриИзмененииРеквизита(Элемент, ОбновлятьИнтерфейс = Истина)
	...
	Если КонстантаИмя = "ИспользоватьУправлениеДоставкой" Тогда
	...
	НастройкиСистемыЛокализацияКлиент.ПриИзмененииРеквизита_СкладИДоставка(Элемент, ЭтотОбъект);
...
Процедура УстановитьДоступность(РеквизитПутьКДанным = "")
	...
	Если РеквизитПутьКДанным = "" Тогда
		...
		ЗапрещеноОтключатьОбособление = ПолучитьФункциональнуюОпцию("ИспользоватьУчетЗатратПоНаправлениямДеятельности");

		ЗапрещеноОтключатьОбособление = ЗапрещеноОтключатьОбособление
...
Процедура УстановитьДоступностьФормированиеЗаказовПоПотребностям()
	...
	ИспользоватьФормированиеЗаказов = НаборКонстант.ИспользоватьПроизводство
