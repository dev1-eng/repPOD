...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Подсказка.Действия.Найти("ВыгрузкаШтрихкодов") <> Неопределено Тогда
		...
		Константа_ПоказыватьПодсказкиПоставщиков = ТорговыеПредложения.ПоказыватьПодсказкиПоставщиков();
		Константа_ПоказыватьПодсказкиПокупателей = ТорговыеПредложения.ПоказыватьПодсказкиПокупателей();
...
Процедура ИзменитьНастройкуПодсказок()
	...
	ТорговыеПредложения.ПоказыватьПодсказкиПокупателейУстановить(Константа_ПоказыватьПодсказкиПокупателей);
	ТорговыеПредложения.ПоказыватьПодсказкиПоставщиковУстановить(Константа_ПоказыватьПодсказкиПоставщиков);
