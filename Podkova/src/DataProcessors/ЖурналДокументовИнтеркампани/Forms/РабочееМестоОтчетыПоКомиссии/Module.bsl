...
Процедура ЗаполнитьТоварыКОформлению()
	...
	РегистрыСведений.УчетнаяПолитикаОрганизаций.СформироватьВТУчетныеПолитикиОрганизаций(Запрос.МенеджерВременныхТаблиц,
		Комиссионер, КонецДня(Период.ДатаОкончания));
