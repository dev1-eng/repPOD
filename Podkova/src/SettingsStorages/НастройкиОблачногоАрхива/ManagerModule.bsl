...
#Область ПараметрыАвторизацииИПП
		...
		Результат = ОбщегоНазначения.СкопироватьРекурсивно(РезультатПоУмолчанию);
...
#Область АдресаВебСервисов
		...
		//
		РезультатПоУмолчанию = Новый Структура;
		РезультатПоУмолчанию.Вставить("АдресWSDLАвторизации1С", ОблачныйАрхив.ПолучитьАдресWSDLАвторизации1С());
		РезультатПоУмолчанию.Вставить("АдресWSDLБэкап1СПубличный", ОблачныйАрхив.ПолучитьАдресWSDLБэкап1СПубличный());
		РезультатПоУмолчанию.Вставить("АдресWSDLБэкап1СПриватный", ОблачныйАрхив.ПолучитьАдресWSDLБэкап1СПриватный());
		РезультатПоУмолчанию.Вставить("АдресWSDLАгентаКопирования", ОблачныйАрхив.ПолучитьАдресRESTAPIВерсийАгентаКопирования());
		Результат = ОбщегоНазначения.СкопироватьРекурсивно(РезультатПоУмолчанию);
