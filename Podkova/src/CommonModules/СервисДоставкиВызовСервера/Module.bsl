...
Функция ПараметрыЗаказаНаДоставкуПоДокументуОснованию(ТипГрузоперевозки, Основание = Неопределено) Экспорт
	...
	Возврат ПараметрыЗаказаНаДоставку(ТипГрузоперевозки, Основание);
...
Функция АдресСДополнительнымиПолями(Тип, Адрес) Экспорт
	...
	НоваяСтрока.Тип = "Квартира";
	НоваяСтрока = ДополнительныеПараметры.Добавить();
	НоваяСтрока.Тип = "Этаж";
	НоваяСтрока = ДополнительныеПараметры.Добавить();
	НоваяСтрока.Тип = "Подъезд";
	НоваяСтрока = ДополнительныеПараметры.Добавить();
	НоваяСтрока.Тип = "Код домофона";
...
Функция ПараметрыЗаказаНаДоставку(ТипГрузоперевозки, Основание = Неопределено)
