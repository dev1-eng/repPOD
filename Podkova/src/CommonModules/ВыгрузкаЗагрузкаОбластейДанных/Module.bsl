...
//	ДанныеСхемыКонфигурации - ДвоичныеДанные, Неопределено - Зарезервирован для использования в будущих версиях БТС
...
//
Функция ВыгрузитьТекущуюОбластьДанныхВАрхив(Знач АдресДанных = Неопределено, РежимВыгрузкиДляТехническойПоддержки = Ложь,
	ДанныеСхемыКонфигурации = Неопределено, ИмяФайлаВыгрузки = Неопределено) Экспорт
