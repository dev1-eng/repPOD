...
//    * SPARK:About;
//    * SPARK:OpenStatusDescription (Описание статуса);
//    * SPARK:WhatIsCompositeIndex (Причины отсутствия информации);
//    * SPARK:WhatIsCompositeIndex (Причины отсутствия информации);
...
Процедура ОбработкаНавигационнойСсылки(Форма, ЭлементФормы, НавигационнаяСсылка, СтандартнаяОбработкаФормой) Экспорт
	...
	Если СтандартнаяОбработкаБиблиотекой = Истина Тогда
		...
		ИначеЕсли ВРег(НавигационнаяСсылка) = ВРег(Настройки.ИПДНавигационнаяСсылкаПодсказки) Тогда // Индекс платежной дисциплины (ИПД), "SPARK:WhatIsPaymentIndex".
			...
			СтандартнаяОбработкаФормой = Ложь;
		ИначеЕсли ВРег(НавигационнаяСсылка) = ВРег(Настройки.СводныйИндикаторНавигационнаяСсылкаПодсказки) Тогда // Сводный индикатор, "SPARK:WhatIsCompositeIndex".
		...
		ИначеЕсли ВРег(НавигационнаяСсылка) = ВРег(Настройки.ОписаниеСтатусаНавигационнаяСсылкаПодсказки) Тогда // Открыть описание статуса
			...
			ОткрытьФорму("Обработка.СправкаСПАРКРиски.Форма.РасшифровкаСтатуса", ПараметрыФормы, Форма);
