...
//  - Структура:
//    * ОшибкаРаботыССервисом - Булево - признак ошибки получения данных (локальных или данных из сервиса)
//    * НастройкиКонтрагента - Структура - см. ДокументыEDIИнтеграция.НовыйНастройкиКонтрагента
//    * ДанныеСтатусаДокумента - Структура - см. ДокументыEDIИнтеграция.НовыйДанныеСтатусаДокумента
//    * ИдентификаторыОбъектов - Структура - см. ДокументыEDIИнтеграция.НовыйИдентификаторыОбъектов
//
...
//   *ВариантУказанияНоменклатуры - ПеречислениеСсылка.ВариантыУказанияНоменклатурыВЗаказеEDI- ссылка на 
...
Процедура ЗагрузитьРевизиюДокументаСервиса(ДанныеДокумента, ОписаниеОповещения, ФормаДокумента) Экспорт
