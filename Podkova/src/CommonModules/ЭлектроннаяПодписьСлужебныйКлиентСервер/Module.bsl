...
Функция ИдентификаторыАлгоритмовПодписи(ТолькоАлгоритмыОткрытогоКлюча)
	...
	Если Не ТолькоАлгоритмыОткрытогоКлюча Тогда
		...
		ИдентификаторыАлгоритмов.Вставить("1.2.643.7.1.1.6.1", ИменаАлгоритмовПодписиГОСТ_34_10_2012_256());
		ИдентификаторыАлгоритмов.Вставить("1.2.643.7.1.1.3.3", ИменаАлгоритмовПодписиГОСТ_34_10_2012_512());
		ИдентификаторыАлгоритмов.Вставить("1.2.643.7.1.1.6.2", ИменаАлгоритмовПодписиГОСТ_34_10_2012_512());
		...
		ИдентификаторыАлгоритмов.Вставить("1.2.840.113549.1.1.11", "RSA_SIGN"); // sha256WithRSAEncryption.
		ИдентификаторыАлгоритмов.Вставить("1.2.840.113549.1.1.12", "RSA_SIGN"); // sha384WithRSAEncryption.
		ИдентификаторыАлгоритмов.Вставить("1.2.840.113549.1.1.13", "RSA_SIGN"); // sha512WithRSAEncryption.
	КонецЕсли;
...
Функция ИдентификаторыАлгоритмовХеширования()
	...
	ИдентификаторыАлгоритмов.Вставить("2.16.840.1.101.3.4.2.1", "SHA-256");
	ИдентификаторыАлгоритмов.Вставить("2.16.840.1.101.3.4.2.2", "SHA-384");
	ИдентификаторыАлгоритмов.Вставить("2.16.840.1.101.3.4.2.3", "SHA-512");
