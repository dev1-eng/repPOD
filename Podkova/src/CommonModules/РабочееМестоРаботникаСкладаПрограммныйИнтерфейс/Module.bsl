...
//
// Возвращаемое значение:
//	Структура - служебная информация о товаре:
...
//		ДокументСсылка.ОтборРазмещениеТоваров, ДокументСсылка.ПересчетТоваров - складское задание, которое принимается
//		в работу.
//	ТипЗадания - Строка - тип складского задания.
//	Пользователь - СправочникСсылка.Пользователи - исполнитель складского задания.
//
...
//
// Возвращаемое значение:
//	Массив - Элементами массива является структура, содержащая данные о ячейках.
//
//		Состав структуры:
//			Ячейка - СправочникСсылка.СкладскиеЯчейки,
//			КодЯчейки - Строка,
