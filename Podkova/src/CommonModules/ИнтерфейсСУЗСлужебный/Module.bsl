...
Функция ТипКодаМаркировки(Знач ЗначениеПоиска) Экспорт
	...
	ИначеЕсли ЗначениеПоиска = Перечисления.ШаблоныКодовМаркировкиСУЗ.Духи
		...
		Или ЗначениеПоиска = Перечисления.ШаблоныКодовМаркировкиСУЗ.ЛегкаяПромышленность
		Или ЗначениеПоиска = Перечисления.ШаблоныКодовМаркировкиСУЗ.УпакованнаяВода
		Или ЗначениеПоиска = Перечисления.ШаблоныКодовМаркировкиСУЗ.МолочнаяПродукцияСерия6СимволовБезВЕТИС
		Или ЗначениеПоиска = Перечисления.ШаблоныКодовМаркировкиСУЗ.МолочнаяПродукцияСерия6СимволовВЕТИС Тогда
		Результат = "UNIT";
