...
Процедура ОбработкаКомандыОтчетаОформлениеДокументов(Форма, ОписаниеКоманды, АктОРасхождениях, ОснованиеАкта, ОформляемыйДокумент) Экспорт
	...
	ИначеЕсли ОписаниеКоманды = "Подтвердить" Тогда
		...
		ОбменСКонтрагентамиКлиент.СформироватьПодписатьОтправитьЭД(ОснованиеАкта, , ОписаниеОповещенияОПодтвержденииЭД);
	...
	ИначеЕсли ОписаниеКоманды = "Отклонить" Тогда
		...
		ОбменСКонтрагентамиКлиент.ОтклонитьЭД(ОснованиеАкта, ОписаниеОповещенияОтклоненииЭД);
