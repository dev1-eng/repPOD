...
//
// Возвращаемое значение:
//	Структура - параметры задания (описание полей структуры приведено в функции 'ПараметрыЗадания()'
...
Функция ОбработатьОтсканированныеТоварыОтбораПеремещенияWS(ИдЗадания, ОтсканированныеТоварыWS) Экспорт
	...
	ПараметрыЗаданияWS = ПараметрыОбработкиОтсканированныхТоваровОтбораWS(ПараметрыЗадания);
...
Функция ЗавершитьВыполнениеСкладскогоЗаданияWS(ИдЗадания, ИдИсполнителя, ОтсканированныеТоварыWS, ТипЗадания,
	...
	ПараметрыЗаданияWS = ПараметрыЗавершенияСкладскогоЗаданияWS(ПараметрыЗадания);
...
//	ПараметрыЗавершенияСкладскогоЗадания XDTO-пакета WMSMobileClientExchange.
//
Функция ПараметрыЗавершенияСкладскогоЗаданияWS(ПараметрыЗадания)
...
//	ПараметрыОбработкиОтсканированныхТоваров XDTO-пакета WMSMobileClientExchange.
//
Функция ПараметрыОбработкиОтсканированныхТоваровОтбораWS(ПараметрыЗадания)
