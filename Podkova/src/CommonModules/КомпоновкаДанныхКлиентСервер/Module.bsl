...
//	ПолеКомпоновки - Строка,ПолеКомпоноквкиДанных - имя поля отбор по которому требуется найти.
//	ВключаяВложенныеПоля - Булево - Признак поиска во вложеных элементах.
//
// Возращаемое значение:
//  Итсина - если по заданному полю установлен действующий отбор
//
