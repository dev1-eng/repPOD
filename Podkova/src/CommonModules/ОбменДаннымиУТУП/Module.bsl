...
Функция ОпределитьПараметрыЗапросаОбъекта(ЭлементДанных, ТипЗначенияОбъекта = Неопределено, ФормироватьИерархию = Истина) Экспорт
	...
	ИначеЕсли ТипЗначенияОбъекта = Тип("ДокументОбъект.ЗаявкаНаВыпускКиЗГИСМ")
		...
		Или ТипЗначенияОбъекта = Тип("ДокументОбъект.УведомлениеОбОтгрузкеМаркированныхТоваровГИСМ") Тогда
		
		ЗначенияФильтра_ДокументыГИСМБезСклада(ЭлементДанных, ПараметрыЗапроса, ФормироватьИерархию);
	...
	ИначеЕсли ТипЗначенияОбъекта = Тип("ДокументОбъект.МаркировкаТоваровГИСМ")
		...
		ЗначенияФильтра_ДокументыГИСМСоСкладом(ЭлементДанных, ПараметрыЗапроса, ФормироватьИерархию);
	...
	ИначеЕсли ТипЗначенияОбъекта = Тип("РегистрСведенийЗапись.НастройкиРаботыСПеревозчикамиСервисДоставки") Тогда
		
		ЗначенияФильтра_РегистрыСведений_НастройкиРаботыСПеревозчикамиСервисДоставки(ЭлементДанных, ПараметрыЗапроса, ФормироватьИерархию);
...
Функция ОбъектНеПроходитФильтр(ЭлементДанных,
	...
	Иначе
		Если ТипЗначенияОбъекта = Тип("ДокументОбъект.ПоступлениеБезналичныхДенежныхСредств") Тогда
			...
			Если ЭлементДанных.ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ПоступлениеОплатыОтКлиента
				...
				Отказ = ОбъектРасчетовВТабличнойЧастиНеСоответствуетФильтру(
					ЭлементДанных, УзелПланаОбмена, СообщениеПользователю, "РасшифровкаПлатежа", "Заказ");
		...
		ИначеЕсли ТипЗначенияОбъекта = Тип("ДокументОбъект.ВводОстатков") Тогда
			...
			Если ЭлементДанных.ТипОперации = Перечисления.ТипыОперацийВводаОстатков.ОстаткиЗадолженностиКлиентов
				ИЛИ ЭлементДанных.ТипОперации = Перечисления.ТипыОперацийВводаОстатков.ОстаткиЗадолженностиПередПоставщиками
				ИЛИ ЭлементДанных.ТипОперации = Перечисления.ТипыОперацийВводаОстатков.ОстаткиПоАвансамКлиентов
				ИЛИ ЭлементДанных.ТипОперации = Перечисления.ТипыОперацийВводаОстатков.ОстаткиПоАвансамПоставщикам Тогда
				//Проверка объекта расчетов
			...
			ИначеЕсли ЭлементДанных.ТипОперации = Перечисления.ТипыОперацийВводаОстатков.ОстаткиПоДоговорамКредитовИДепозитов Тогда
...
Процедура ЗначенияФильтра_ВводОстатков(Объект, ПараметрыЗапроса, ФормироватьИерархию)
	...
	ИначеЕсли Объект.ТипОперации = Перечисления.ТипыОперацийВводаОстатков.ОстаткиЗадолженностиКлиентов
		ИЛИ Объект.ТипОперации = Перечисления.ТипыОперацийВводаОстатков.ОстаткиЗадолженностиПередПоставщиками
		ИЛИ Объект.ТипОперации = Перечисления.ТипыОперацийВводаОстатков.ОстаткиПоАвансамКлиентов
	...
	ИначеЕсли Объект.ТипОперации = Перечисления.ТипыОперацийВводаОстатков.ОстаткиПоДоговорамКредитовИДепозитов Тогда
	...
	ИначеЕсли Объект.ТипОперации = Перечисления.ТипыОперацийВводаОстатков.ОстаткиСобственныхТоваров
		...
		ИЛИ Объект.ТипОперации = Перечисления.ТипыОперацийВводаОстатков.ОптовыеПродажиЗаПрошлыеПериоды 
		ИЛИ Объект.ТипОперации = Перечисления.ТипыОперацийВводаОстатков.РозничныеПродажиЗаПрошлыеПериоды Тогда
	...
	ИначеЕсли Объект.ТипОперации = Перечисления.ТипыОперацийВводаОстатков.ОстаткиТМЦВЭксплуатации
		ИЛИ Объект.ТипОперации = Перечисления.ТипыОперацийВводаОстатков.ОстаткиПрочихАктивовПассивов
		ИЛИ Объект.ТипОперации = Перечисления.ТипыОперацийВводаОстатков.ОстаткиПрочихРасходов 
		ИЛИ Объект.ТипОперации = Перечисления.ТипыОперацийВводаОстатков.ФинансовыйРезультатЗаПрошлыеПериоды Тогда
...
Процедура ЗначенияФильтра_ДокументыГИСМБезСклада(Объект, ПараметрыЗапроса, ФормироватьИерархию)
	
	ОтборПоОрганизацииОбъекта(Объект, ПараметрыЗапроса, ФормироватьИерархию);
	
КонецПроцедуры

Процедура ЗначенияФильтра_ДокументыГИСМСоСкладом(Объект, ПараметрыЗапроса, ФормироватьИерархию)
...
Процедура ЗначенияФильтра_РегистрыСведений_НастройкиРаботыСПеревозчикамиСервисДоставки(Объект, ПараметрыЗапроса, ФормироватьИерархию)
	ОтборПоОрганизацииОбъекта(Объект, ПараметрыЗапроса, ФормироватьИерархию);
КонецПроцедуры
...
Процедура ЗначенияФильтра_Справочники_Патенты(Объект, ПараметрыЗапроса, ФормироватьИерархию)
	...
	Запрос = Новый Запрос("ВЫБРАТЬ
		|	ТабЧастьДокумента.Подразделение КАК Подразделение
		|ПОМЕСТИТЬ ТаблицаПодразделений
		|ИЗ
		|	&ТабличнаяЧасть КАК ТабЧастьДокумента
		|;
		|
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
	...
	ПараметрыЗапроса.РеквизитПроверкиПодразделения = НСтр("ru = 'Подразделение, указанное в табличной части объекта'");
	ПараметрыЗапроса.Подразделения                 = МассивОбъектов;
	ПараметрыЗапроса.ФильтрПоПодразделению         = Истина;
