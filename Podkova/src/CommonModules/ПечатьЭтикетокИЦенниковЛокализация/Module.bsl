...
Процедура ДополнитьТаблицуШтрихкодамиУпаковок(ТаблицаДанных) Экспорт
	...
	Для Каждого СтрокаТаблицы Из ТаблицаДанных Цикл
		Если ЗначениеЗаполнено(СтрокаТаблицы.Штрихкод) 
			...
			Если СтрокаТаблицы.ШтрихкодВBase64 Тогда
				Штрихкод = ШтрихкодированиеИСКлиентСервер.Base64ВШтрихкод(СтрокаТаблицы.Штрихкод);
			Иначе
				Штрихкод = СтрокаТаблицы.Штрихкод;
			КонецЕсли;
			
			ЗаполнитьСвойстваСтрокиШтрихкодовУпаковокПоШтрихкоду(СтрокаТаблицы, Штрихкод);
...
Процедура ПечатьЭтикетокИСМП(ТаблицаДанных, ТабличныйДокумент, СтруктураНастроек) Экспорт
	...
	Для Каждого СтрокаТовары Из СтруктураРезультата.Таблица Цикл
		...
		Если РазмерыШаблоновРазличны И ЗначениеЗаполнено(СтрокаТовары.ШаблонЭтикетки) Тогда
