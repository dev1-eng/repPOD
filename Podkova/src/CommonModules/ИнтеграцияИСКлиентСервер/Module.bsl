...
Функция ДвоичныеДанныеPOSTЗапросаКакФорма(ПоляФормы) Экспорт
	...
	Для Каждого ПолеФормы Из ПоляФормы Цикл
		...
		ТекстовыйДокумент.ДобавитьСтроку("--" + Разделитель);
		ТекстовыйДокумент.ДобавитьСтроку(ОписаниеСодержимого);
		ТекстовыйДокумент.ДобавитьСтроку(ОписаниеТипа);
		ТекстовыйДокумент.ДобавитьСтроку("");
		ТекстовыйДокумент.ДобавитьСтроку(ПолеФормы.Тело);
	...
	ВозвращаемоеЗначение.ДвоичныеДанные = ПолучитьДвоичныеДанныеИзСтроки(ТекстовыйДокумент.ПолучитьТекст());
