...
Процедура ПриИзмененииОтбораПоАктуальности(Список, Актуальность, ДатаСобытия) Экспорт
	...
	ИначеЕсли Актуальность = "Послезавтра" Тогда
		ДатаСобытия = ОбщегоНазначенияУТВызовСервера.ДатаСеанса() + 2*86400;
	ИначеЕсли Актуальность = "Через неделю" Тогда
		ДатаСобытия = ОбщегоНазначенияУТВызовСервера.ДатаСеанса() + 7*86400;
	...
	ИначеЕсли Актуальность = "Все" 
		...
		Актуальность = "";
		ДатаСобытия      = Дата(1,1,1);
	ИначеЕсли СтрНайти(Актуальность, "Истекает на") > 0 Тогда
		Актуальность = "Истекает на " + Формат(ДатаСобытия, "ДФ=dd.MM.yy");
	ИначеЕсли Актуальность = "Просрочен" ИЛИ Актуальность = "Просроченные" Тогда
		Актуальность = "Просрочен";
		ДатаСобытия      = Дата(1,1,1);
	ИначеЕсли Актуальность = "Не просрочен" ИЛИ Актуальность = "Не просроченные" Тогда
