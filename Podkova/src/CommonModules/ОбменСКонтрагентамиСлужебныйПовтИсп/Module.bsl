...
Функция МодульСопоставлениеНоменклатурыКонтрагентов() Экспорт
	
	Возврат ОбщегоНазначения.ОбщийМодуль("СопоставлениеНоменклатурыКонтрагентов");
	
КонецФункции

Функция МодульСопоставлениеНоменклатурыКонтрагентовПереопределяемый() Экспорт
	
	Возврат ОбщегоНазначения.ОбщийМодуль("СопоставлениеНоменклатурыКонтрагентовПереопределяемый");
	
КонецФункции

Функция МодульСопоставлениеНоменклатурыКонтрагентовСлужебный() Экспорт
	
	Возврат ОбщегоНазначения.ОбщийМодуль("СопоставлениеНоменклатурыКонтрагентовСлужебный");
	
КонецФункции

Функция МодульСопоставлениеНоменклатурыКонтрагентовСлужебныйВызовСервера() Экспорт
	
	Возврат ОбщегоНазначения.ОбщийМодуль("СопоставлениеНоменклатурыКонтрагентовСлужебныйВызовСервера");
