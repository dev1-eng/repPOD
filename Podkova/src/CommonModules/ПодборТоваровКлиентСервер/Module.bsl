...
//
// Возвращаемое значение:
//	Строка - имя списка номенклатуры партнера по варианту поиска.
//
...
// Возвращает имя страницы списка страниц номенклатуры партнера на форме подбора, которую надо сделать текущей
// в зависимости от включенного типа поиска.
//
// Параметры:
//	Форма - ФормаКлиентскогоПриложения - форма списка, форма подбора.
...
// Устанавливает отбор по диапазону цен поставщиков на список номенклатуры партнера в формах подборов.
//
// Параметры:
...
Процедура УстановитьОтборПоДиапазонуЦенПоставщика(Форма) Экспорт
	...
	// Отбор на список номенклатуры партнера.
...
// Устанавливает значения доступности элементов фильтра номенклатуры партнера в зависимости от значения
// флажка использования фильтра номенклатуры партнера.
//
// Параметры:
//	Форма - ФормаКлиентскогоПриложения - форма списка номенклатуры или форма подбора.
//
...
// Устанавливает отбор по группе номенклатуры в списке номенклатуры партнера.
// Если на форме используется вариант навигации отличный от навигации по иерархии,
// то отбор не устанавливается.
//
// Параметры:
...
// Отключает установленный отбор по группе номенклатуры партнера у списка номенклатуры партнера
// на форме подбора.
//
// Параметры:
//  Форма - ФормаКлиентскогоПриложения - форма списка номенклатуры или форма подбора.
...
Процедура УстановитьТекстИнформационнойНадписи(Форма) Экспорт
	...
	ФорматнаяСтрока = НСтр("ru = 'Л = ru_RU; ДП = Ложь; НП = Истина'; НД = Ложь;'");
