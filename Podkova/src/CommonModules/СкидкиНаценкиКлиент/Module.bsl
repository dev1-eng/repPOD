...
//
// Параметры:
//  ТипУсловия                                        - Перечисление.УсловияПредоставленияСкидокНаценок - тип
//      создаваемого условия
//  ДанныеДляЗаполненияРодителя                       - Справочник.УсловияПредоставленияСкидокНаценок - в качестве
//                                                                                                      родителя нового
//                                                                                                      условия будет
//                                                                                                      установлен
//                                                                                                      родитель
...
//                                                                                                      данном параметре
//                                                                                                      условия.
//  ИспользоватьФормуСправочникаУсловияПредоставления - Булево - если Истина, то будет открыта форма элемента
//                                                               справочника УсловияПредоставленияСкидокНаценок, если
//                                                               Ложь, то форма УсловияПредоставленияСкидокНаценок
//                                                               справочника СкидкиНаценки.
//
...
Процедура ОткрытьФормуПримененныеСкидки(ТекущиеДанные, Объект, Форма, ДополнительныеПараметры = Неопределено) Экспорт
	...
	Если ТипЗнч(Объект.Ссылка) = Тип("ДокументСсылка.АктВыполненныхРабот")
		Или ТипЗнч(Объект.Ссылка) = Тип("ДокументСсылка.КоммерческоеПредложениеКлиенту") Тогда
...
//  РазвернутыеУзлыДерева - СписокЗначений - список, в котором хранятся значения скидок (наценок), соответствующие узлы
//                                           которым будут развернуты.
//
...
//
// Параметры:
//  Форма    - ФормаКлиентскогоПриложения - форма, из которой открывается история.
//  Источник  - СправочникСсылка.Склады, СправочникСсылка.ВидыКартЛояльности, СправочникСсылка.СоглашенияСКлиентом -
