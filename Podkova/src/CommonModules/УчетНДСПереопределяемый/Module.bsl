...
Функция ТекстЗапросаИнформацияПоТНВЭД() Экспорт
	...
	|	ВЫБОР
	|		КОГДА ДанныеОснованийСчетовФактур.СтавкаНДС = ЗНАЧЕНИЕ(Перечисление.СтавкиНДС.НДС0)
	...
	|	СчетаФактурыВЕАЭС.СчетФактура,
	|	ВЫБОР
	|		КОГДА СчетФактураВыданныйТовары.СтавкаНДС = ЗНАЧЕНИЕ(Перечисление.СтавкиНДС.НДС0)
