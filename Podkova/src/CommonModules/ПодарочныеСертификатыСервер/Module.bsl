...
//
// Параметры:
//  СтруктураДанныхКарты - Структура с данными подарочного сертификата, см. функцию ПодарочныеСертификатыВызовСервера.ИнициализироватьОписаниеПодарочногоСертификата().
//
...
Функция ПодготовитьТаблицуДвиженияДенежныеСредстваКонтрагент(ОплатаПодарочныеСертификаты, ОплатаПлатежныеКарты) Экспорт
	...
	Для Каждого ПоКарте Из ОплатаПлатежныеКарты Цикл
		...
		Для Каждого Сертификат Из ОплатаПодарочныеСертификаты Цикл
			...
			Сумма =     ВзаиморасчетыСервер.СписатьСумму(ПоКарте.СуммаОплатыВВалютеПлатежа, Сертификат.СуммаОплатыВВалютеПлатежа);
			СуммаУпр =  ВзаиморасчетыСервер.СписатьСумму(ПоКарте.СуммаОплаты,               Сертификат.СуммаОплаты);
			СуммаРегл = ВзаиморасчетыСервер.СписатьСумму(ПоКарте.СуммаОплатыРегл,           Сертификат.СуммаОплатыРегл);
