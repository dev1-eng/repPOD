...
Процедура ПриПодбореУчетногоДокумента(Знач Настройки, Знач ОповещениеОВыборе, СтандартнаяОбработка = Истина) Экспорт
	...
	Если Настройки.ИмяОбъектаМетаданных = "Документ.СчетФактураПолученный" Тогда
		...
		Кнопки.Добавить(КодВозвратаДиалога.Да, НСтр("ru='Счета-фактуры полученные'"));
		Кнопки.Добавить(КодВозвратаДиалога.Нет, НСтр("ru='Счета-фактуры полученные (аванс)'"));
...
Процедура ОткрытьФормуВыбораДоговора(Параметры, Владелец, ОповещениеОЗакрытии, СтандартнаяОбработка) Экспорт
	...
	//++ НЕ ГОСИС
	ЭлектронноеВзаимодействиеУТКлиент.ОткрытьФормуВыбораДоговора(
