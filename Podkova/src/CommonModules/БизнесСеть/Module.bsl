...
Функция НовыйДанныеКонтрагентовБизнесСети()
	...
	ДанныеКонтрагентов = Новый ТаблицаЗначений;
	ДанныеКонтрагентов.Колонки.Добавить("Контрагент", Метаданные.ОпределяемыеТипы.КонтрагентEDI.Тип);
...
Процедура НайтиКонтрагентовПоНатуральнымКлючам(ДанныеКонтрагентов)
	...
	Для Каждого ДанныеКонтрагента Из ДанныеКонтрагентов Цикл
		...
		Если ЗаписьИнформационнойБазы = Неопределено Или
			Не ЗначениеЗаполнено(ЗаписьИнформационнойБазы.Контрагент) Тогда
...
Процедура ПриОпределенииНастроекРегламентныхЗаданий(Зависимости) Экспорт
	...
	Зависимость.РегламентноеЗадание = Метаданные.РегламентныеЗадания.ОбновлениеИдентификаторовКонтрагентовБизнесСети;
...
Процедура ПриПолученииСпискаШаблонов(ШаблоныЗаданий) Экспорт
	...
	ШаблоныЗаданий.Добавить("ОбновлениеИдентификаторовКонтрагентовБизнесСети");
