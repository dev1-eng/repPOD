...
//
// Параметры:
// Форма - ФормаКлиентскогоПриложения - форма рабочего места,
...
//		ДокументСсылка.ОтборРазмещениеТоваров, ДокументСсылка.ПересчетТоваров - складское задание, которое принимается в работу,
...
//
// Параметры:
//  Форма	 - ФормаКлиентскогоПриложения	 - рабочее место работника склада.
//
...
//
// Параметры:
//	Форма - ФормаКлиентскогоПриложения - форма обработки рабочего места,
...
//
// Параметры:
//	Форма - ФормаКлиентскогоПриложения - форма мобильного рабочего места,
...
//
// Параметры:
//	ПолныйВариант - Булево - вариант состава полей структуры, принимает значения:
