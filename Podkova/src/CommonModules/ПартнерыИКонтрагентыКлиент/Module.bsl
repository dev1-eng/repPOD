...
//  ВидКонтактнойИнформации  - ПеречислениеСсылка.ВидыКонтактнойИнформации - вид КИ, значение которого устанавливается.
...
// информационной панели. Параметры:
//  Форма                - ФормаКлиентскогоПриложения - форма, в которой выполняется команда.
//
...
//  РеквизитыКомпании    - Структура        - реквизиты контрагента.
//
Процедура ЗаполнитьИсториюАдресовВФорме(Объект, РеквизитыКомпании) Экспорт
