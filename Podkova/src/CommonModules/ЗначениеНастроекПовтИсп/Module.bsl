...
//	Договор - СправочникСсылка.ДоговорыКонтрагентов, СправочникСсылка.ДоговорМеждуОрганизациями - Договор, выбранный в документе
//	НаправлениеДеятельности - СправочникСсылка.НаправленияДеятельности - Направление деятельности, выбранное в документе
//	Дата - Дата определения системы налогообложения по организации и складу.
//
// Возвращаемое значение:
...
// Возвращаемое значение:
//	Структура
//		Ключ 	 - имя реквизита справочника УчетныеПолитикиОрганизаций
//		Значение - значение реквизита
//
Функция ПараметрыУчетнойПолитики(Организация, Период = Неопределено) Экспорт
	
	Возврат РегистрыСведений.УчетнаяПолитикаОрганизаций.ПараметрыУчетнойПолитики(Организация, Период);
