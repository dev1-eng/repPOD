...
//  Возвращает рассчитанную строку для.
//
// Параметры:
...
Процедура ДобавитьВсеВозможныеСпособыОтработкиАктаПоПриобретению(Форма)
...
Процедура ДобавитьСпособыОтработкиАктаПоПриобретениюИсправление(Форма)
...
Процедура ДобавитьСпособыОтработкиАктаПоПриобретениюКорректировка(Форма)
...
Процедура ДобавитьВсеВозможныеСпособыОтработкиАктаПоРеализации(Форма)
...
Процедура ДобавитьСпособыОтработкиКорректировкаРеализации(Форма)
...
Функция ДокументУчаствуетВЭДО(Документ) Экспорт
	...
	Если СтатусДокументооборота = "ЭДОНеНастроен"
		...
		Или СтатусДокументооборота = "Ошибка"
		Или СтатусДокументооборота = "ЭДОНеИспользуется" Тогда
...
Процедура ОбработкаВыбораПодборНаСервере(Форма, КэшированныеЗначения, ВыбранноеЗначение, ЭтоАктОРасхожденияПослеОтгрузки) Экспорт
	...
	Для каждого СтрокаТовара Из ТаблицаТоваров Цикл
		...
		СтруктураДействий.Вставить("ЗаполнитьСтавкуНДС",
			Новый Структура("НалогообложениеНДС, Дата", Форма.Объект.НалогообложениеНДС, Форма.Объект.Дата));
...
Процедура ЗаполнитьДоговорПоУмолчанию(Объект, ХозяйственнаяОперацияДоговора) Экспорт
	...
	ИначеЕсли Объект.ТипОснованияАктаОРасхождении = Перечисления.ТипыОснованияАктаОРасхождении.ВозвратТоваровОтКлиента
		Тогда
...
Процедура СформироватьТаблицуДокументовОснований(Форма, МассивДокументовОснований = Неопределено) Экспорт
	...
	Пока ВыборкаРеализации.Следующий() Цикл
		...
		Пока ВыборкаЗаказы.Следующий() Цикл
			...
			Если Форма.Объект.ТипОснованияАктаОРасхождении = Перечисления.ТипыОснованияАктаОРасхождении.ПриобретениеТоваровУслуг Тогда
