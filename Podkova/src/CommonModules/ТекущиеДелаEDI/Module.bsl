...
// 
// Параметры:
// 	Виджет - ПеречислениеСсылка.ДоступныеВиджетыТекущихДелEDI - виджет, для которого требуется отпределить доуступность.
...
//
Функция ПодготовленныеДанныеДляВиджетов(ИспользуемыеВиджеты, ИспользуемыеРазделы) Экспорт
...
// Удаляет группу элементов формы виджета из таблицы зависомостей
// 
// Параметры:
...
// 	Структура - Описание:
// * Включена                  - Булево - 
// * ИмяПодчиненнойГруппы      - Строка - имя подченнной группы.
...
//
Функция НоваяСтрокаТаблицыВиджетов(ТаблицаВиджетов, Виджет, Группировка) Экспорт
...
//
Процедура ДобавитьГруппуВиджетов(ТаблицаВиджетов, ГруппаВиджетов) Экспорт
...
Процедура УстановитьПометкиТаблицаВиджетовСогласноВыбраннымЗначениям(ТаблицаВиджетов, ВыбранныеВиджеты) Экспорт
