...
// Процедура устанавливает текущим элементом - список номенклатуры партнера.
//
// Параметры:
//	Форма - ФормаКлиентскогоПриложения - форма подбора.
//
...
// Процедура вызывается при активизации строки списка иерархии номенклатуры партнера.
//
// Параметры:
//	Форма - ФормаКлиентскогоПриложения - форма списка, форма подборов.
//
...
// Процедура вызывается при активизации строки таблицы номенклатуры партнера на формах подборов.
//
// Параметры:
//	Форма   - ФормаКлиентскогоПриложения - форма подбора товаров,
//	Элемент - Таблица          - список номенклатуры партнера.
//
Процедура ПриАктивизацииСтрокиНоменклатурыПартнера(Форма, Элемент) Экспорт
	...
	ПараметрыТовара.Вставить("НоменклатураПартнера", СтрокаТаблицыНоменклатурыПартнера.Ссылка);
...
// в документы закупки. Возникает при переключении на страницу с номенклатурой партнера и обратно.
//
// Параметры:
...
// Вызывается из форм подборов при изменении флажка использования фильтров для номенклатуры партнера.
//
// Параметры:
...
// Функция формирует параметры перетаскивания из списков номенклатуры, номенклатуры партнера и характеристики номенклатуры.
//
// Параметры:
//  Форма					 - ФормаКлиентскогоПриложения			 - форма подбора,
...
// Устанавливает отбор по родителю текущей строки списка номенклатуры партнера
...
Процедура УстановитьОтборПоРодителюТекущейСтрокиНоменклатурыПартнера(Форма)
	...
	ТекущаяСтрока = Форма.Элементы[ПодборТоваровКлиентСервер.ИмяСпискаНоменклатурыПартнераПоВариантуПоиска(Форма)].ТекущаяСтрока;
	Если ТекущаяСтрока = Неопределено Тогда
		Возврат;
	КонецЕсли;
...
// Устанавливает текущую строку иерархии номенклатуры номенклатуры партнера в форме подбора по закупкам.
//
//	Форма - ФормаКлиентскогоПриложения - форма списка, форма подбора.
//
