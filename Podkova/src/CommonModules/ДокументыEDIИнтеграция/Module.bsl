...
// 
// Возвращаемое значение:
// 	Булево - Истина - в случаее, если используется EDI и у пользователя достаточно прав для использования,
//           Ложь - в ином случае.
Функция ЕстьПравоИспользованияEDI() Экспорт
	
	ЕстьПравоИспользоватьEDI = Пользователи.ЭтоПолноправныйПользователь() 
		Или РольДоступна("РаботаСДокументамиEDI");
...
Процедура ПриСозданииНаСервере(ПараметрыФормыДокумента) Экспорт
	...
	РазместитьНаФормеПодменюКомандEDI(ФормаДокумента, ПараметрыФормыДокумента);
	
	Если Не ЕстьПравоИспользованияEDI() Тогда
		Возврат;
	КонецЕсли;
	
	ТипДокумента = ТипДокументаEDIПоТипуПрикладногоДокумента(ТипЗнч(ФормаДокумента.Объект.Ссылка));
	
	Если Не ИспользоватьПодсистему(ТипДокумента) Тогда
		Возврат;
	КонецЕсли;
...
Процедура ПриПолученииДанныхНаСервереСписокДокументов(ТипДокумента, ИмяЭлемента, Настройки, Строки) Экспорт
	...
	Для каждого ЭлементКоллекции Из Строки Цикл
		...
		ДанныеСтроки.СостояниеEDI = ДокументыEDIИнтеграция.ПредставлениеСостоянияEDIПрикладногоДокумента(ДанныеДокумента);
...
//
Процедура ПрПриСохраненииДанныхВНастройкахНаСервере(Форма, Настройки) Экспорт
...
//
Функция ПредставлениеСостоянияEDIПрикладногоДокумента(ДанныеДокумента) Экспорт
...
// Возвращаемое значение:
// 	Массив - Описание
Функция СостоянияСоответствияПрикладнойДокументНеАктуален() Экспорт
...
Функция ПредставлениеСостоянияСоответствияПрикладногоОбъектаДокументуEDI(СостояниеЗагруженногоОбъекта) Экспорт
...
Функция МассивТиповДокументовДляКоторыхОтслеживаетсяОтправкаПоПрикладномуОбъекту() Экспорт
...
Процедура УстановитьОтборСтатусСоответствияПрикладногоОбъекта(Форма) Экспорт
	...
	ГруппаЭлементовОтбора = ОбщегоНазначенияКлиентСервер.СоздатьГруппуЭлементовОтбора(Форма.Список.КомпоновщикНастроек.ФиксированныеНастройки.Отбор.Элементы,
	                                                                                  НСтр("ru = 'Отбор по состоянию соответствия прикладного объетка EDI'"),
...
Процедура ФормаСпискаПрикладныхОбъектовСоздатьДополнительныеРеквизитыФормы(Форма, ПараметрыИнтеграции) Экспорт
...
Процедура ФормаСпискаПрикладныхОбъектовПреобразоватьЗапросДинамическогоСписка(Форма, ПараметрыИнтеграции) Экспорт
...
Процедура УстановитьУсловноеОформлениеСостояниеСоответствияПрикладногоДокумента(СписокУсловноеОформление) 
	...
	ОтборЭлемента.ПравоеЗначение = ДокументыEDIИнтеграция.СостоянияСоответствияПрикладнойДокументНеАктуален();
...
Функция ПользователюДоступнаОбработкаEDI(КатегорияДокументовEDI) Экспорт
...
Функция МассивПустыхЗначенийПрикладныхОбъектов() Экспорт
...
Процедура РазместитьНаФормеПодменюКомандEDI(Форма, НастройкиФормы)
	
	МестоРазмещенияКомандПоУмолчанию = НастройкиФормы.МестоРазмещенияКоманд;
...
Функция РезультатЗагрузкиПрикладногоДокумента(ДанныеДокумента, ТаблицаСопоставления, МодельЗаказа, РезультатОбновления,
	...
	ОбновленныеДанныеДокумента = ВыполнитьЗаписьРеестраПоДаннымСервисаПриЗагрузкеОбновлении(
		ДанныеДокумента,
		ОтветСервиса, 
...
Функция ИспользоватьПодсистему(ТипДокумента)
...
Процедура ЗаполнитьПоследнююНастройкуВариантаУказанияНоменклатуры(ФормаДокумента)
	...
	ДанныеДокумента.ПоследняяНастройкаВариантаУказанияНоменклатуры = РегистрыСведений.СостоянияДокументовEDI.ПоследняяНастройкаВариантаУказанияНоменклатуры(
		ДанныеДокумента.Контрагент, ДанныеДокумента.Организация, ФормаДокумента.ТипДокументаEDI);
