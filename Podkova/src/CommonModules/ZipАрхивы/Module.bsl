...
Функция ИзвлечьФайл(ДанныеАрхива, ИмяФайла, Каталог) Экспорт
	...
	ДанныеАрхива.КонецКаталога.Буфер.ЗаписатьЦелое32(12, НайденнаяЗапись.Буфер.Размер); // РазмерКаталога
	ДанныеАрхива.КонецКаталога.Буфер.ЗаписатьЦелое32(16, Размер); // СмещениеКаталога
