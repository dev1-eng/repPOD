...
Процедура ПолучитьТекстЗапросаОбновлениеПакетаПредложений(ТекстЗапроса) Экспорт
	...
	|	втНоменклатура.Номенклатура.ИспользованиеХарактеристик КАК ИспользованиеХарактеристик,
	|	втНоменклатура.Номенклатура.ВидНоменклатуры КАК ВидНоменклатуры,
	|	втНоменклатура.Номенклатура.ВладелецХарактеристик КАК ВладелецХарактеристик
	|ПОМЕСТИТЬ втНоменклатураИспользованиеХарактеристик
	|ИЗ
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ РАЗРЕШЕННЫЕ
	|	втНоменклатураИспользованиеХарактеристик.Номенклатура КАК Номенклатура,
	|	ХарактеристикиНоменклатуры.Ссылка КАК Ссылка
	|ПОМЕСТИТЬ втХарактеристикиНоменклатурыНеполные
	|ИЗ
	|	втНоменклатураИспользованиеХарактеристик КАК втНоменклатураИспользованиеХарактеристик
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Справочник.ХарактеристикиНоменклатуры КАК ХарактеристикиНоменклатуры
	|		ПО (втНоменклатураИспользованиеХарактеристик.ИспользованиеХарактеристик = ЗНАЧЕНИЕ(Перечисление.ВариантыИспользованияХарактеристикНоменклатуры.ИндивидуальныеДляНоменклатуры))
	|			И (ХарактеристикиНоменклатуры.Владелец = втНоменклатураИспользованиеХарактеристик.Номенклатура)
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	|	втНоменклатураИспользованиеХарактеристик.Номенклатура,
	|	ХарактеристикиНоменклатуры.Ссылка
	|ИЗ
	|	втНоменклатураИспользованиеХарактеристик КАК втНоменклатураИспользованиеХарактеристик
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Справочник.ХарактеристикиНоменклатуры КАК ХарактеристикиНоменклатуры
	|		ПО (втНоменклатураИспользованиеХарактеристик.ИспользованиеХарактеристик = ЗНАЧЕНИЕ(Перечисление.ВариантыИспользованияХарактеристикНоменклатуры.ОбщиеДляВидаНоменклатуры))
	|			И (ХарактеристикиНоменклатуры.Владелец = втНоменклатураИспользованиеХарактеристик.ВидНоменклатуры)
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	...
	|	втНоменклатураИспользованиеХарактеристик КАК втНоменклатураИспользованиеХарактеристик
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Справочник.ХарактеристикиНоменклатуры КАК ХарактеристикиНоменклатуры
	|		ПО (втНоменклатураИспользованиеХарактеристик.ИспользованиеХарактеристик = ЗНАЧЕНИЕ(Перечисление.ВариантыИспользованияХарактеристикНоменклатуры.ОбщиеСДругимВидомНоменклатуры))
	|			И (ХарактеристикиНоменклатуры.Владелец = втНоменклатураИспользованиеХарактеристик.ВладелецХарактеристик)
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	втНоменклатура.Номенклатура КАК Номенклатура,
	|	ЕСТЬNULL(втХарактеристикиНоменклатурыНеПолные.Ссылка, ЗНАЧЕНИЕ(Справочник.ХарактеристикиНоменклатуры.ПустаяСсылка)) КАК Ссылка
	|ПОМЕСТИТЬ втХарактеристикиНоменклатуры
	|ИЗ
	|	втНоменклатура КАК втНоменклатура
	|		ЛЕВОЕ СОЕДИНЕНИЕ втХарактеристикиНоменклатурыНеполные КАК втХарактеристикиНоменклатурыНеПолные
	|		ПО втНоменклатура.Номенклатура = втХарактеристикиНоменклатурыНеПолные.Номенклатура
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ РАЗРЕШЕННЫЕ
	...
	|		ПО (втНоменклатура.Номенклатура = ХарактеристикиНоменклатуры.Номенклатура)
...
Процедура ЗаполнитьЗаказ(ДокументОбъект, РеквизитыЗаказа, СвойстваЗаказа,
	...
	Если РеквизитыЗаказа.Свойство("ДатаОтгрузки")
		...
		ДокументОбъект.ЖелаемаяДатаОтгрузки = РеквизитыЗаказа.ДатаОтгрузки;
	КонецЕсли;
...
Процедура ПолучитьПоСтавкеНДСЗначениеДляВыгрузки(СтавкаНДС, ЗначениеСтавкиНДС) Экспорт
	...
	//++ НЕ ГОСИС
	ЗначениеСтавкиНДС = УчетНДСУПКлиентСервер.ПолучитьСтавкуНДС(СтавкаНДС);
	//-- НЕ ГОСИС
