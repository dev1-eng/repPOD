...
Процедура ВыгрузитьОсновныеСправочники(Фабрика, ЗаписьXML) Экспорт
	...
	|	ЛОЖЬ КАК ВидКИРедактированиеТолькоВДиалоге,
...
// Выполняет проверку того, что данные нужно переносить в данный узел
//
// Параметры:
...
//
// Параметры:
//  ВариантАнализа - СправочникСсылка.ВариантыАнализаЦелевыхПоказателей - вариант анализа, сериализованный объект
...
// Параметры:
//  ЗаписьXML - ЗаписьXML - сообщение обмена;
//  Клиент - СправочникСсылка.Партнер - клиент, чьих контактных лиц необходимо выгрузить в обмен;
...
Процедура ВыгрузитьКонтактныхЛицКлиента(Фабрика, ЗаписьXML, Клиент, УдалениеДанных)
	...
	Запрос = Новый Запрос;
	Запрос.Текст = ТекстЗапросаКонтактныхЛицКлиента();
...
Функция ТекстЗапросаКонтактныхЛицКлиента()
