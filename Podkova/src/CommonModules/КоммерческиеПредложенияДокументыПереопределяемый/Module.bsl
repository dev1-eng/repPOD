...
//
// Параметры:
//  Настройки - Структура - см. КоммерческиеПредложенияДокументы.НастройкиУчета
//
...
//   * Ссылка   - Ссылка - ссылка на созданный документ.
...
//   Партнер                          - ОпределяемыйТип.Партнер - ссылка на справочник партнеры.
...
//
// Параметры:
//  ТекущиеДела - Массив - список текущих дел.
...
// Параметры:
//  ИмяОбъекта - Строка - имя объекта, в котором произошло событие
//  Ограничение - Структура - см. УправлениеДоступомСлужебный.ОписаниеОграниченияДанных
//
...
// Параметры:
//  Форма                   - ФормаКлиентскогоПриложения - форма, в которой выполнена команда
//  ВыделенныеСтроки        - Массив       - выделенные строки табличной части "Товары", для которых применяются скидки
//  РезультатОбработки      - Произвольный - можно поместить произвольные данные для дальнейшей обработки на клиенте
...
//
// Параметры:
//   СписокНоменклатур - Массив - список номенклатуры для которой требуется расшифровка
//   ЗначенияПолейТоваров - Соответствие - Значения полей элементов номенклатуры
//     * Ключ     - Произвольный - Значение элемента массива
//     * Значение - Структура    - Значение полей требуемых заполнить
//        ** НоменклатураСсылка       - Ссылка - ссылка на номенклатуру из массива 'СписокНоменклатур'
...
//
// Параметры:
//  СписокХарактеристик - Массив - Список характеристик номенклатуры для которой требуется расшифровка
//  ЗначенияПолейХарактеристик - Соответствие - Значения полей элементов массива Характеристики
//    * Ключ     - Произвольный - Значение элемента массива
//    * Значение - Структура    - Значение полей требуемых заполнить
//        ** ХарактеристикаСсылка       - Ссылка - ссылка на характеристику из массива 'СписокХарактеристик'
...
//
// Параметры:
//  СписокЕдиницИзмерения - Массив - Список единиц измерения для которой требуется расшифровка
//  ЗначенияПолей - Соответствие - Значения полей элементов массива ЕдиницыИзмерения
//   * Ключ     - Произвольный - Значение элемента массива
//   * Значение - Структура    - Значение полей требуемых заполнить
...
//
// Параметры:
//  СписокНоменклатур - Массив  - Список полей для получения штрихкодов
...
//
// Параметры:
//  Контрагент - Ссылка  - Ссылка на контрагента.
//  Партнер    - Ссылка  - Ссылка на партнера.
//
...
// Заполняет представление адреса и код ФИАС по определяемому типу "СкладыЭДО".
//
// Параметры:
//  Склад        - ОпределяемыйТип.СкладыЭДО - ссылка на склад.
...
// Параметры:
//  Форма                                 - ФормаКлиентскогоПриложения - форма, в которой произошло событие,
//  МассивИдентификаторовДобавленныхСтрок - Массив - указывает на добавленные строки.
//
...
//  - ТабличнаяЧасть       - ТабличнаяЧастьФормы        - табличная часть, из которой копируются строки.
//  - ВыделенныеСтроки     - Массив                     - копируемые строки.
