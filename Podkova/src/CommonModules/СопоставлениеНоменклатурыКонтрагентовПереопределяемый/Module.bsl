...
// При необходимости дополнительные параметры можно описать в методе см. УстановитьПараметрыДинамическогоСписка_ФормаВыбораНоменклатурыКонтрагентов.
//
// Параметры:
...
// Определяет свойства переданной упаковки или единицы измерения номенклатуры информационной базы.
//
// Параметры:
...
// Например: т (тонна) будет упаковкой для кг (киллограмм).
//
// Параметры:
...
//
// Параметры:
//  НоменклатураКонтрагента - Структура из см. ОбменСКонтрагентамиКлиентСервер.НоваяНоменклатураКонтрагента        - данные номенклатуры контрагента.
//  НоменклатураИБ          - Структура из см. ОбменСКонтрагентамиКлиентСервер.НоваяНоменклатураИнформационнойБазы - данные номенклатуры информационной базы.
...
// Переопределяет заполнение владельца номенклатуры контрагента по дереву ЭД.
//
// Параметры:
...
// Описание свойств см. СопоставлениеНоменклатурыКонтрагентовКлиентСервер.НовыеСвойстваНоменклатурыИБ.
//
// Параметры:
...
//
// Параметры:
//  НоменклатураИБ        -      Структура         - см. СпосоставлениеНоменклатурыКонтрагентовКлиентСервер.НоваяНоменклатураИнформационнойБазы
...
// Методы с реализацией находятся в модуле ЭлектронноеВзаимодействиеКлиентПереопределяемый.
//
// Параметры:
