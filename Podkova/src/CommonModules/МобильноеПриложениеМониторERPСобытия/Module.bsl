...
//
// Параметры:
//  Источник - СправочникОбъект.КонтактныеЛицаПартнеров, СправочникОбъект.Партнеры,
//             СправочникОбъект.ВариантыАнализаЦелевыхПоказателей, СправочникОбъект.ВариантыОтчетов - источник события;
