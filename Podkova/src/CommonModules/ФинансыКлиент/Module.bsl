...
//	ВыборОснованияПлатежа - Булево - Выбор основания платежа, а не объекта расчетов.
...
//	УчитыватьФилиалы - Булево - Показывать документы по филиалам организации.
...
Процедура РасшифровкаПлатежаПриНачалеРедактирования(
	...
	ИспользоватьЗаказы = Истина) Экспорт
	
	Если ИспользоватьЗаказы Тогда
		
		ЭтоРасчетыСКлиентами = ЭтоРасчетыСКлиентами(Объект.ХозяйственнаяОперация);
		
		УстановитьПустуюСсылкуНаЗаказ(СтрокаТаблицы.Заказ, ЭтоРасчетыСКлиентами);
