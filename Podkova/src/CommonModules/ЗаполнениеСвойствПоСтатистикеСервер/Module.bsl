...
Функция ЗаполнитьСвойстваОбъекта(Объект, ДанныеЗаполнения = Неопределено) Экспорт
	...
	ВозвращаемоеЗначение = ЗаполнитьСвойства(Объект, , ДанныеЗаполнения);
...
//	УчитыватьАвтора - Булево - признак того, что при получении статистики будет добавлен отбор по автору.
//
Процедура ПолучитьЗначенияСвойств(Ссылка, ЗаполняемыеРеквизиты, РеквизитыДляОтбора, УчитыватьАвтора = Истина) Экспорт
	...
	Если УчитыватьАвтора И НЕ РеквизитыДляОтбора.Свойство("Автор")
		И ОбщегоНазначенияУТКлиентСервер.ЕстьРеквизитОбъекта(Ссылка, "Автор") Тогда
...
#КонецОбласти
	...
	ЗаполняемыйРеквизит.НовоеЗначение = ЗаполнениеСвойствПоСтатистикеПовтИсп.ЗначениеРеквизитаПоСтатистике(
