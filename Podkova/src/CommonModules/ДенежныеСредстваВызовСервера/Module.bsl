...
//
// Параметры:
// Ссылки - Массив, СписокЗначений - заявки на расходование средств, по которым необходимо создать платежные поручения.
//
// Возвращаемое значение:
...
//             Документ - ДокументСсылка, СправочникСсылка - документ, на основании которого нужно сформировать списание
//                                                           ДС
...
Процедура РазобратьВыпискуБанка(ЭлектроннаяВыпискаБанка) Экспорт
	...
	ДенежныеСредстваСервер.РазобратьВыпискуБанка(ЭлектроннаяВыпискаБанка);
