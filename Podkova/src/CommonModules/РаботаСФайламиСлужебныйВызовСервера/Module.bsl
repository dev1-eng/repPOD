...
Функция ОбновитьОбъектФайла(ФайлСсылка, СведенияОФайле, ВерсияСсылка = Неопределено, 
	...
	Попытка
		...
		Если ТипХраненияФайлов = Перечисления.ТипыХраненияФайлов.ВТомахНаДиске Тогда
			ТипХраненияФайлов = РаботаСФайламиВТомахСлужебный.ТипХраненияФайла(Версия.Расширение, СведенияОФайле.Размер);
		КонецЕсли;
		...
		РегистрыСведений.КодировкиФайлов.ЗаписатьКодировкуВерсииФайла(Версия.Ссылка, КодировкаПредВерсии);
	   	РаботаСФайламиВТомахСлужебный.ЗаполнитьСведенияОФайле(Версия, ДвоичныеДанные,,Истина);
		ЗафиксироватьТранзакцию();
