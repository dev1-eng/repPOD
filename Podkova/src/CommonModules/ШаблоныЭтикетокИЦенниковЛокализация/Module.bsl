...
Процедура ПриПолученииПараметровДляПечатиОбразцаЭтикеткиШтрихкодыУпаковок(ДляЧего, ТипКода, УникальныйИдентификатор, ПараметрыПечати) Экспорт
	...
	ПараметрыПечати.АдресВХранилище = ПоместитьВоВременноеХранилище(ТаблицаШтрихкодов, УникальныйИдентификатор);
...
Процедура ПриПолученииПараметровДляПечатиОбразцаЭтикеткиИСМП(ДляЧего, ТипКода, УникальныйИдентификатор, ПараметрыПечати) Экспорт
	...
	//++ Локализация
	СтрктураПечатиЭтикеток = Новый Структура();
	СтрктураПечатиЭтикеток.Вставить("РежимПечати", "Выборочно");
	...
	СтрктураПечатиЭтикеток.Вставить("ОбъектыПечати", ОбъектыПечати);
	
	ПараметрыПечати.АдресВХранилище = ПоместитьВоВременноеХранилище(СтрктураПечатиЭтикеток, УникальныйИдентификатор);
	ПараметрыПечати.ШаблонЭтикетки  = Справочники.ШаблоныЭтикетокИЦенников.ПустаяСсылка();
	//-- Локализация
	Возврат;
