...
Процедура ЗначениеРеквизитаИСНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	СтандартнаяОбработка = Ложь;
	ВыбратьЗначениеРеквизитаИС(Элементы.ЗначениеРеквизитаИС);
...
&НаКлиенте
Процедура ВыбратьЗначениеРеквизитаИС(Элемент);
	
	Типы = ТипРеквизитаОбъектаИС.Типы();
	
	ПараметрыВыбора = Новый Структура;
	ПараметрыВыбора.Вставить("ОписаниеТипа", ТипРеквизитаОбъектаИС);
	ПараметрыВыбора.Вставить("ТекстРедактирования", Элемент.ТекстРедактирования);
	
	Если Типы.Количество() = 1 Тогда 
		ВыбратьЗначениеРеквизитаИСЗавершениеВыбораТипа(Типы[0], ПараметрыВыбора);
	Иначе
...
&НаКлиенте
Процедура ВыбратьЗначениеРеквизитаИСЗавершениеВыбораТипа(ЗначениеТипа, ПараметрыВыбора) Экспорт
	
	ОписаниеТипа = ПараметрыВыбора.ОписаниеТипа;
	
	Оповещение = Новый ОписаниеОповещения("ВыбратьЗначениеРеквизитаИСЗавершениеВводаЗначения", ЭтаФорма);
	...
	ИначеЕсли ЗначениеТипа = Тип("Число") Тогда 
		ЗначениеРеквизита = ЗначениеРеквизитаИС;
	...
	ИначеЕсли ЗначениеТипа = Тип("Булево") Тогда
		ЗначениеРеквизита = ЗначениеРеквизитаИС;
		ПоказатьВводЗначения(Оповещение, ЗначениеРеквизита, ПредставлениеРеквизитаОбъектаИС, Тип("Булево"));
		
	Иначе
		ИмяОбъекта = ИмяОбъектаМетаданныхПоТипу(ЗначениеТипа);
		ПараметрыФормы = Новый Структура;
		ПараметрыФормы.Вставить("РежимВыбора", Истина);
		ПараметрыФормы.Вставить("ТекущаяСтрока", ЗначениеРеквизитаИС);
		Если ИмяОбъекта = "Справочник.ЗначенияСвойствОбъектов" Тогда
			Отбор = Новый Структура("Владелец", ДополнительныйРеквизитИС);
...
Процедура УстановитьДоступность()
	...
	Элементы.Обновлять.Доступность = НЕ Вариант = УказанноеЗначение;
