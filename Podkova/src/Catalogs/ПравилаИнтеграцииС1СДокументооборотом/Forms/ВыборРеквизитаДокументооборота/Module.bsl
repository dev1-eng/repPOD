...
&НаСервере
Процедура ЗаполнитьДеревоРеквизитов(РеквизитыОбъектаДО,
	...
	Для Каждого Реквизит Из РеквизитыОбъектаДО Цикл
		...
		Если ЗначениеЗаполнено(Таблица)
			И ЗначениеЗаполнено(Реквизит.Таблица)
			И Таблица <> Реквизит.Таблица Тогда
		...
		Если Не ЗначениеЗаполнено(Таблица)
			И Не ЭтоТаблица
			И (ЗначениеЗаполнено(Реквизит.Таблица)
				Или Реквизит.ЭтоТаблица) Тогда
			НоваяСтрока.Недоступно = Истина;
		КонецЕсли;
		
		НоваяСтрока.Выделено = 
			ЗначениеЗаполнено(Таблица)
			И Реквизит.ЭтоТаблица
			И Таблица = Реквизит.Имя;
