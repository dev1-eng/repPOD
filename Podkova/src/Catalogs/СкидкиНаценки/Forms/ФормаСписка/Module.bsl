...
Процедура ДобавитьВЗапросТекстИнформациюПоИндивидуальнымСоглашениям(ЗапросТекст)
	...
	ЗапросТекст = СтрЗаменить(ЗапросТекст, "%ИндивидуальныеСоглашенияТаблица%", ИндивидуальныеСоглашенияТаблица);
...
Процедура ДобавитьВЗапросТекстИнформациюПоТиповымСоглашениям(ЗапросТекст)
	...
	ЗапросТекст = СтрЗаменить(ЗапросТекст, "%ТиповыеСоглашенияТаблица%", ТиповыеСоглашенияТаблица);
...
Процедура ДобавитьВЗапросТекстИнформациюПоКартамЛояльности(ЗапросТекст)
	...
	ЗапросТекст = СтрЗаменить(ЗапросТекст, "%КартыЛояльностиТаблица%", КартыЛояльностиТаблица);
