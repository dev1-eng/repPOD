...
Функция ТекстЗапросаДанныеЗаписейСкладскогоЖурнала() Экспорт
	...
	|	КОЛИЧЕСТВО (РАЗЛИЧНЫЕ ЗначенияИзВСД.ВСД.МестоДляКарантинирования)                           КАК КоличествоМестДляКарантинирования,
	|	МАКСИМУМ   (ЗначенияИзВСД.ВСД.МестоДляКарантинирования)                                     КАК МестоДляКарантинирования,
	|	КОЛИЧЕСТВО (РАЗЛИЧНЫЕ ЗначенияИзВСД.ВСД.КоличествоДнейДляКарантинирования)                  КАК КоличествоПериодовПоКарантинированию,
	|	МАКСИМУМ   (ЗначенияИзВСД.ВСД.КоличествоДнейДляКарантинирования)                            КАК КоличествоДнейДляКарантинирования,
	...
	|	ВЫБОР КОГДА ЕСТЬNULL(ВТРеквизитыДокументовИзВСД.КоличествоМестДляКарантинирования,0) = 1
	|		ТОГДА ВТРеквизитыДокументовИзВСД.МестоДляКарантинирования
	|	ИНАЧЕ НЕОПРЕДЕЛЕНО КОНЕЦ                                        КАК МестоДляКарантинирования,
	|	ВЫБОР КОГДА ЕСТЬNULL(ВТРеквизитыДокументовИзВСД.КоличествоПериодовПоКарантинированию,0) = 1
	|		ТОГДА ВТРеквизитыДокументовИзВСД.КоличествоДнейДляКарантинирования
	|	ИНАЧЕ НЕОПРЕДЕЛЕНО КОНЕЦ                                        КАК КоличествоДнейДляКарантинирования,
