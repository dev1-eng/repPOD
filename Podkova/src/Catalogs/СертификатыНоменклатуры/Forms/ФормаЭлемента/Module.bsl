...
Функция РеквизитыИзображения(СсылкаНаФайл)
	...
	Попытка
		АдресФайлаВХранилище = РаботаСФайлами.ДанныеФайла(СсылкаНаФайл, УникальныйИдентификатор).СсылкаНаДвоичныеДанныеФайла;
	...
	Возврат Новый Структура("АдресФайлаВХранилище, ПометкаУдаления, ПриПолученииДанныхКартинкиВозниклаОшибка",
							АдресФайлаВХранилище, ПометкаУдаления, ПриПолученииДанныхКартинкиВозниклаОшибка);
