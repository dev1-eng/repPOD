...
Функция ПараметрыЗаполненияНалогообложенияНДС(Справочник) Экспорт
	...
	РеквизитыСправочника = Новый Структура("Организация, ОрганизацияПолучатель, ТипДоговора, 
											|НалогообложениеНДСОпределяетсяВДокументе");
...
//
Функция ПараметрыЗаполненияВидаДеятельностиНДС(Справочник) Экспорт
	
	РеквизитыСправочника = Новый Структура("Организация, ТипДоговора, ЗакупкаПодДеятельностьОпределяетсяВДокументе, 
