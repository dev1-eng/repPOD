...
//
// Параметры:
//  ДанныеЗаполнения  - Структура - см. ПараметрыСозданияКонтактногоЛица
//
// Возвращаемое значение:
//   Структура   - содержит следующие поля:
//     * КонтактноеЛицо - СправочникСсылка.КонтактныеЛицаПартеров - созданный элемент справочника, 
...
//    * Пол                   - ПеречисленияСсылка.ПолФизическогоЛица,
