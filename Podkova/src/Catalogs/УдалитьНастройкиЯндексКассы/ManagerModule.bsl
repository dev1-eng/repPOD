...
//
// Параметры:
//  ТолькоСДоговором  - Булево, Неопределено - признак того, что нужно возвращать организации только по настройкам для
//                                             варианта с договором и наоборот, если Неопределено будет выдано по всем
...
//
// Параметры:
//  КлючиПоиска  - Структура, ФиксированнаяСтруктура, Соответствие, ФиксированноеСоответствие - Ключи поиска по которым
//    необходимо искать данные, поиск работает по логическому "И".
...
//
// Возвращаемое значение:
//   СправочникСсылка.НастройкиЯндексКассы - Ссылка на найденную настройку, если ничего не найдено будет возвращена
//                                           пустая ссылка.
//
...
// Параметры:
//  Настройка - СправочникОбъект.НастройкиЯндексКассы, ДанныеФормыСтруктура - элемент, для которого нужно отработать
//                                                                            логику связи реквизитов.
//
// Возвращаемое значение:
...
Функция ПолучитьТабличныйДокументКарточкиНастройки(Настройка) Экспорт
	...
	ИначеЕсли ТипЗнч(Настройка) = Тип("СправочникОбъект.НастройкиЯндексКассы")
		...
		Или ТипЗнч(Настройка) = Тип("ФормаКлиентскогоПриложения") Тогда
		Объект = Настройка;
	Иначе
...
#Область ШаблоныПисем
	...
	Если ТипЗнч(Настройка) = Тип("ФормаКлиентскогоПриложения") 
