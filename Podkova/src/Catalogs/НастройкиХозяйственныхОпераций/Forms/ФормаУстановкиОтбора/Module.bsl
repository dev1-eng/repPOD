...
Процедура ЗавершитьСозданием()
	...
	Если Иерархия = "ПоХозОперациям" Тогда
		ТекущиеДанные = Элементы.ДеревоПоХозяйственнымОперациям.ТекущиеДанные;
		ТекстПредупрежедения = НСтр("ru = 'Выберите хозяйственную операцию.'");
	Иначе
		ТекущиеДанные = Элементы.ДеревоПоДокументам.ТекущиеДанные;
		ТекстПредупрежедения = НСтр("ru = 'Выберите документ.'");
	КонецЕсли;
	
	Если ТекущиеДанные = Неопределено Тогда
		ПоказатьПредупреждение(,ТекстПредупрежедения,,НСтр("ru = 'Ошибка выбора.'"));
		Возврат;
	КонецЕсли;
