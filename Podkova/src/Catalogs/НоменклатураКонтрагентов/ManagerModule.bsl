...
Функция ИдентификаторНоменклатурыКонтрагентаПоНаименованию(Знач Номенклатура, Знач Характеристика, Знач Упаковка) Экспорт
	...
	Идентификатор = Номенклатура + "#" + Характеристика + "#" + Упаковка;
	Возврат ЭлектронноеВзаимодействиеСлужебный.ИдентификаторТовараПоСтроке(Идентификатор, 300);
...
Процедура ПараметрыПоискаДублей(ПараметрыПоиска, ДополнительныеПараметры = Неопределено) Экспорт
	...
	НастройкиКомпоновщикОтбора.Отбор.Элементы.Очистить();
	
	ЭлементОтбора = НастройкиКомпоновщикОтбора.Отбор.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
