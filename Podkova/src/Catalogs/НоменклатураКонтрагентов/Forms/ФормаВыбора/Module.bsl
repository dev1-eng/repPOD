...
Процедура УстановитьУсловноеОформлениеФормы()
	...
	// Выделение цветом текста несопоставленной номенклатуры контрагента
	Элемент = Список.УсловноеОформление.Элементы.Добавить();
	Элемент.Представление = НСтр("ru = 'Выделение цветом текста несопоставленной номенклатуры контрагента.'");
