...
Процедура ОбработкаПолученияДанныхВыбора(ДанныеВыбора, Параметры, СтандартнаяОбработка)
	...
	ОтборПоКонтрагенту = Новый СписокЗначений;
	ОтборПоКонтрагенту.Добавить(Справочники.Контрагенты.ПустаяСсылка());
	...
	Если Параметры.Отбор.Свойство("Организация", Организация) Тогда
		ОтборПоКонтрагенту.Добавить(Организация);
		УсловиеОтбораПоОрганизации = "И СправочникСоглашениеСПоставщиком.Организация В (&ОтборПоОрганизации)";
	КонецЕсли;
	
	УсловиеОтбораПоКонтрагенту =  "";
	Если Параметры.Отбор.Свойство("Контрагент", Контрагент) Тогда
		ОтборПоКонтрагенту.Добавить(Контрагент);
		УсловиеОтбораПоКонтрагенту = "И СправочникСоглашениеСПоставщиком.Контрагент В (&ОтборПоКонтрагенту)";
	КонецЕсли;
	...
	Запрос.Текст = СтрЗаменить(Запрос.Текст, "//УсловиеОтбораПоОрганизации", УсловиеОтбораПоОрганизации);
	Запрос.Текст = СтрЗаменить(Запрос.Текст, "//УсловиеОтбораПоКонтрагенту", УсловиеОтбораПоКонтрагенту);
