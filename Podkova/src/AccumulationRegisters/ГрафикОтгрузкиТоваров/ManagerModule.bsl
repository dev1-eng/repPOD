...
//   * Отбор  - Произвольный   - фиктивный параметр, предназначенный для постобработки полученного текста запроса, путем
//                               замены данного параметра на произвольный текст. Предполагается что произвольный текст
//                               будет формулировать дополнительные условия отбора на получаемые данные. Пример подмены
//                               подстроки "&Отбор": "Таблица.Номенклатура = &Номенклатура И Таблица.Характеристика = &Характеристика".
//
