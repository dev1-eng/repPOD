...
Процедура ПриЗаписи(Отказ, Замещение)
	...
	ТекстЗаданияКРасчетуСебестоимости = 
	"ВЫБРАТЬ РАЗЛИЧНЫЕ
	...
	|";
	МассивТекстовЗапроса.Добавить(ТекстЗаданияКРасчетуСебестоимости);
	МассивТекстовЗапроса.Добавить("УНИЧТОЖИТЬ ПартииПрочихРасходовПередЗаписью");
	МассивТекстовЗапроса.Добавить("УНИЧТОЖИТЬ втПартийПрочихРасходовРазница");
