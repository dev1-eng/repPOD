...
Процедура ПриЗаполненииОграниченияДоступа(Ограничение) Экспорт
	...
	|ГДЕ
	|	ЗначениеРазрешено(ЗаказНаПеремещение.Организация)
	|	И( ЗначениеРазрешено(ЗаказНаПеремещение.СкладОтправитель)
	|	ИЛИ ЗначениеРазрешено(ЗаказНаПеремещение.СкладПолучатель)
	|	) ";
