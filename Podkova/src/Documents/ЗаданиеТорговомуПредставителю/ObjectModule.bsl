...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если НЕ ЗначениеЗаполнено(Соглашение)
		ИЛИ НЕ Документы.ЗаданиеТорговомуПредставителю.ЗначениеРеквизитаОбъектаТипаБулево(Соглашение, "ИспользуютсяДоговорыКонтрагентов") Тогда
...
Процедура ПроверитьВозможностьИспользованияДанныхТорговымиПредставителями(Отказ)
	...
	Если ЗначениеЗаполнено(Партнер) Тогда
		...
		Если Не Документы.ЗаданиеТорговомуПредставителю.ЗначениеРеквизитаОбъектаТипаБулево(Партнер, "ОбслуживаетсяТорговымиПредставителями") Тогда
	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьСоглашенияСКлиентами") И ЗначениеЗаполнено(Соглашение) Тогда
		...
		Если Не Документы.ЗаданиеТорговомуПредставителю.ЗначениеРеквизитаОбъектаТипаБулево(Соглашение, "ИспользуетсяВРаботеТорговыхПредставителей") Тогда
