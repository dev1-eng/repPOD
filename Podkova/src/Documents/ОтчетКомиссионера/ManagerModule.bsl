...
Функция ПараметрыРегистрацииСчетовФактурКомиссионеру(Документ) Экспорт		
	...
	Реквизиты = Новый Структура("Ссылка, Дата, Контрагент, Организация, НалогообложениеНДС");		
...
Процедура ИнициализироватьВтСуммыДокументовВВалютахУчета(Запрос, ТекстыЗапроса) Экспорт
	...
	|	ОтчетКомиссионера.Валюта КАК ВалютаДокумента,
	|	ОтчетКомиссионера.Валюта КАК ВалютаВзаиморасчетов,
	|	"""" КАК ИдентификаторСтроки,
	|	ОтчетКомиссионера.СтавкаНДСВознаграждения КАК СтавкаНДС,
	|	ОтчетКомиссионера.СуммаВознаграждения КАК СуммаСНДС,
...
Функция ТекстЗапросаТаблицаРасчетыСКлиентами(Запрос, ТекстыЗапроса, Регистры)
	...
	ТекстЗапроса=СтрЗаменить(ТекстЗапроса,"//ЗачетАвансовКлиентаПоНакладной", 
		ВзаиморасчетыСервер.ТекстПроведенияЗачетАвансовКлиентаПоНакладной("ОтчетКомиссионера", ШаблонПолей, "РасшифровкаПлатежаСКлиентом"));
...
Функция ТекстЗапросаТаблицаРасчетыСПоставщиками(Запрос, ТекстыЗапроса, Регистры)
	...
	ТекстЗапроса=СтрЗаменить(ТекстЗапроса,"//ЗачетАвансовПоставщикуПоНакладной",
		ВзаиморасчетыСервер.ТекстПроведенияЗачетАвансовПоставщикуПоНакладной("ОтчетКомиссионера", ШаблонПолей, "РасшифровкаПлатежаСПоставщиком"));
...
Функция ТекстЗапросаТаблицаСебестоимостьТоваров(Запрос, ТекстыЗапроса, Регистры) Экспорт
	...
	|	ТаблицаУслуги.ВидДеятельностиНДС 					 КАК КорВидДеятельностиНДС,
...
Функция ТекстЗапросаТаблицаСуммыДокументовВВалютеРегл(Запрос, ТекстыЗапроса, Регистры)
	...
	|	ПересчитаннаяТаблицаДокумента.СуммаСНДС КАК СуммаВзаиморасчетов,
	|	&Валюта КАК ВалютаВзаиморасчетов
	|ИЗ
