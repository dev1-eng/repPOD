...
Процедура ЗаполнитьПараметрыИнициализации(Запрос, ДокументСсылка, СтруктураДополнительныеСвойства)
	...
	|ИЗ
	|	Документ.ВводОстатковПрослеживаемыхИмпортныхТоваров КАК ДанныеДокумента
	|ГДЕ
...
Функция ТекстЗапросаТаблицаТоварыОрганизаций(Запрос, ТекстыЗапроса, Регистры)
	...
	|	ЛОЖЬ											КАК Первичное
	|ИЗ
	|	Документ.ВводОстатковПрослеживаемыхИмпортныхТоваров.ВидыЗапасов КАК ТаблицаВидыЗапасов
...
Функция ПолноеИмяОбъекта()
	...
	Возврат "Документ.ВводОстатковПрослеживаемыхИмпортныхТоваров";
