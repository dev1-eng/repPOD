...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(
		...
		"Ссылка",
		?(ЗначениеЗаполнено(Распоряжения), Распоряжения, Неопределено),
		ВидСравненияКомпоновкиДанных.ВСписке,,
		ЗначениеЗаполнено(Распоряжения));
	ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(
		СписокВозвратыТоваровОтКлиентов,
	...
	ИначеЕсли Параметры.Свойство("ИмяТекущейСтраницы") Тогда
	...
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "СписокСоздать", "Видимость", ДобавлениеДоступно И НЕ ИспользоватьКомиссиюПриПродажах И НЕ ИспользоватьРозничныеПродажи);		
