...
Процедура ИнициализироватьРеквизиты()
	...
	ОбластиХозОперацииВрем.Вставить(Перечисления.ОбластиПланированияПлатежей.Лизинг, Перечисления.ХозяйственныеОперации.ОплатаЛизингодателю);
...
Процедура ИнициализироватьОбластиПланированияОтбор()
	...
	Если ИспользоватьЛизинг Тогда
		СписокОбластей.Добавить(Перечисления.ОбластиПланированияПлатежей.Лизинг);
	КонецЕсли;
...
Процедура УстановитьОтборДинамическихСписков()
	...
	Для каждого ЭлементСписка Из ОбластиПланированияОтбор Цикл
		Если ЭлементСписка.Пометка Тогда
			...
			ХозОперации.Добавить(ОбластиХозОперации.Получить(ЭлементСписка.Значение));
		КонецЕсли;
	КонецЦикла;
