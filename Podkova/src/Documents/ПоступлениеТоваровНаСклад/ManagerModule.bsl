...
//
// Параметры:
//	Документ - ДанныеФормыСтруктура, ДокументСсылка.ПоступлениеТоваровНаСклад,
//				ДокументОбъект.ПоступлениеТоваровНаСклад - документ поступления товаров на склад.
//
// Возвращаемое значение:
...
Функция ТекстЗапросаВтТаблицаСерииТоваров(Запрос, ТекстыЗапроса)
	...
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.ПоступлениеТоваровНаСклад.Товары КАК ТаблицаТовары
...
Функция ТекстЗапросаТаблицаТоварыОрганизаций(Запрос, ТекстыЗапроса, Регистры)
	...
	|		ТаблицаТовары.АналитикаУчетаНоменклатурыТоварыУПартнеров,
	|		ТаблицаТовары.ВидЗапасов
	|		) КАК ТаблицаТовары
	|
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.ПоступлениеТоваровНаСклад.ВидыЗапасов КАК ВидыЗапасов
	...
	|		И ТаблицаТовары.ВидЗапасов = ВидыЗапасов.ВидЗапасовНаСкладе
	|
	|ГДЕ
	...
	|	ИЛИ ТаблицаТовары.Ссылка.ХозяйственнаяОперация В
	...
	|	И НЕ ТаблицаТовары.АналитикаУчетаНоменклатурыТоварыУПартнеров.Номенклатура.ВестиУчетПоГТД)
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
...
Функция ПолучитьДанныеДляПечатнойФормыОтборРазмещениеТоваров(ПараметрыПечати, МассивДокументов) Экспорт
	...
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.ПоступлениеТоваровНаСклад КАК Поступление
