...
Процедура ОбработкаПроверкиЗаполненияНаСервере(Отказ, ПроверяемыеРеквизиты)
	...
	Если Объект.КроссТаблица Тогда
		...
		СтруктураДействий.Вставить("ПоляГруппировки", "Номенклатура,Характеристика,Назначение,Упаковка,Склад,ВариантКомплектации");
	...
	Если ПланированиеПоНазначениямВТЧ И ЕстьДобавленныеСтроки Тогда
		...
		Для Каждого СтруктураТовар Из МассивСтруктурТовары Цикл
			...
			Если ЗначениеЗаполнено(ПроверяемаяНоменклатура) Тогда
				...
				Если СтруктураТовар.Свойство("ЗагружаемыйВариантКомплектации") И ЗначениеЗаполнено(СтруктураТовар.ЗагружаемыйВариантКомплектации) Тогда
					
					ПроверяемыйВариантКомплектации = Справочники.ВариантыКомплектацииНоменклатуры.НайтиПоНаименованию(СтруктураТовар.ЗагружаемыйВариантКомплектации);
					Если ЗначениеЗаполнено(ПроверяемыйВариантКомплектации) Тогда
						СтруктураТовар.Вставить("ВариантКомплектации", ПроверяемыйВариантКомплектации.Ссылка);
					КонецЕсли;
					ПроверяемыйВариантКомплектации = Неопределено;
...
Процедура СкопироватьИзКроссТаблицы(КэшированныеЗначения)
	...
	Если Объект.КроссТаблица 
		...
		Планирование.ЗаполнитьТаблицуИзКроссТаблицы(Объект.Товары, ТоварыПоДатам, ПараметрыПреобразования, 
...
Функция ПараметрыВидаПлана(Форма)
	...
	ПараметрыВидаПлана = Новый Структура("ЗаполнятьСклад, ПланированиеПоНазначениям, ЗаполнятьНазначениеВТЧ");
