...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если Не ЗначениеЗаполнено(Соглашение)
		Или Не Документы.РеализацияТоваровУслуг.ЗначениеРеквизитаОбъектаТипаБулево(Соглашение, "ИспользуютсяДоговорыКонтрагентов") Тогда
...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	Для Каждого стр из ЭтотОбъект.Товары Цикл  
		Если стр.РаботаВыполнена = Ложь Тогда
			...
			Движение.Сумма= стр.ЗарплатаРаботника;  
		КонецЕсли;	
	КонецЦикла;	
	//--
...
Процедура ЗаполнитьСтрокуВидовЗапасов(СтрокаТоваров, СтруктураПоиска, Параметры, СоответствиеВидовЗапасов)
	...
	Для Каждого СтрокаЗапасов Из ВидыЗапасов.НайтиСтроки(СтруктураПоиска) Цикл
		...
		ЗаполняемыеСвойства = "Упаковка, Цена, СтавкаНДС, АналитикаУчетаНаборов, КодТНВЭД";
