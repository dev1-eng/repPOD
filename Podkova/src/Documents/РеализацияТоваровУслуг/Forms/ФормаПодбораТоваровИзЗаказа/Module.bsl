...
Процедура ЗаполнитьТаблицуТоваров(Документ, ВалютаДокумента)
	...
	ПараметрыЗаполнения.Вставить("Курс", Параметры.Курс);
	ПараметрыЗаполнения.Вставить("Кратность", Параметры.Кратность);
...
Процедура ПерезаполнитьКоличествоПодобрано(СЗаполнением = Ложь, ТоварыРеализации = Неопределено)
	...
	Для каждого ТекСтрока Из ТаблицаТоваров Цикл
		...
		Если ТекСтрока.КоличествоУпаковок <> КоличествоУпаковокДоИзм Тогда
			...
			Иначе
				ТекСтрока.СуммаРучнойСкидки = ТекСтрока.СуммаРучнойСкидкиПоЗаказу * (ТекСтрока.Количество / ТекСтрока.КоличествоВЗаказе);
