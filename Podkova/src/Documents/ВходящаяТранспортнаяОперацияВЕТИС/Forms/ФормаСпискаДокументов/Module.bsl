...
Процедура Оформить(Команда)
	...
	Если ТТНПродукция = 0 Тогда //продукция
		Если НЕ ИнтеграцияИСКлиент.ВыборСтрокиДинамическогоСпискаКорректен(Элементы.СписокКОформлению, Ложь) Тогда
			Возврат;
		КонецЕсли;
		...
		КонецЕсли;
	Иначе 
		Если НЕ ИнтеграцияИСКлиент.ВыборСтрокиДинамическогоСпискаКорректен(Элементы.СписокТТНКОформлению,Истина) Тогда
			Возврат;
