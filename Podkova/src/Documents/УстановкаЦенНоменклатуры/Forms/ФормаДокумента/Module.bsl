...
Процедура ДеревоЦенНоменклатураПриИзмененииНаСервере(ИдентификаторСтроки)
	...
	ТекущаяСтрока = Этаформа.ДеревоЦен.НайтиПоИдентификатору(ИдентификаторСтроки);
...
Функция ПараметрыОткрытияФормыВыбораПараметровРасчета(ЗагрузкаСтарыхЦен = Ложь, ОкруглениеРучныхЦен = Ложь)
	...
	ВыбранныеВидыЦен = УстановкаЦенКлиентСервер.ВыбранныеВидыЦен(ЭтаФорма);
	СтруктураВозврата = Новый Структура();
	СтруктураВозврата.Вставить("ЗагрузкаСтарыхЦен", ЗагрузкаСтарыхЦен);
	СтруктураВозврата.Вставить("ОкруглениеРучныхЦен", ОкруглениеРучныхЦен);
	СтруктураВозврата.Вставить("РучныеВидыЦен", РучныеВидыЦен);
	СтруктураВозврата.Вставить("ДатаДокумента", Объект.Дата);
	СтруктураВозврата.Вставить("ТолькоВыделенные", ТолькоВыделенные);
	СтруктураВозврата.Вставить("ВсеВидыЦен", ВыбранныеВидыЦен);
...
Процедура КонтрольНеСогласованныхИзмененийОбработатьСобытиеПриИзменении(Элемент)
	...
	Иначе
		...
		ИначеЕсли СтрНайти(Элемент.Имя, "ДеревоЦенНоменклатура") > 0 Тогда
