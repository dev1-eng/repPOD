...
Процедура ИнициализироватьДанныеДокумента(ДокументСсылка, ДополнительныеСвойства, Регистры = Неопределено) Экспорт
	...
	РаспределениеДоходовИРасходовПоНаправлениямДеятельностиЛокализация.ДополнитьТекстыЗапросовПроведения(Запрос, ТекстыЗапроса, Регистры);
...
Процедура РезультатРаспределенияПоБазе(Запрос, ТекстыЗапроса, ДополнительныеСвойства)
	...
	ЗапросРаспределения.Текст = 
		...
		+ ТекстЗапросаТаблицаОборотыДоходовРасходов()
	...
	// Результат[4] - ТаблицаДоходыРасходыКРаспределению
	// Результат[5] - ТаблицаОборотыДоходовРасходов
	// Результат[6] - ТаблицаБазыРаспределения.
	РезультатРаспределения = РаспределитьДоходыИРасходыПоБазе(Результат[4].Выгрузить(), Результат[6], ДополнительныеСвойства, Запрос.Параметры.Ссылка);
