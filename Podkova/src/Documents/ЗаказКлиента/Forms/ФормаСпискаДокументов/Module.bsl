...
Процедура ПриОткрытии(Отказ)
	...
	ДокументыEDIИнтеграцияКлиент.ФормаСпискаПриОткрытии(ЭтотОбъект, Отказ);
...
Процедура ПриСохраненииДанныхВНастройкахНаСервере(Настройки)
	...
	// ИнтеграцияEDI
	ДокументыEDIИнтеграция.ПрПриСохраненииДанныхВНастройкахНаСервере(ЭтотОбъект, Настройки);
	// Конец ИнтеграцияEDI
...
Процедура УстановитьВидимостьЭлементов()
	...
	Элементы.СписокОбработкаПомощникЗачетаОплатЗачетОплаты.Видимость = ИспользоватьРасширенныеВозможностиЗаказаКлиента;
