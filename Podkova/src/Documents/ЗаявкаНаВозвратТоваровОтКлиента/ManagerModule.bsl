...
//
// Параметры:
//	Объект         - ДокументОбъект.ЗаявкаНаВозвраТоваровОтКлиента, ДанныеФормыСтруктура - Документ, даты поступления которого необходимо заполнить
//
...
//
Функция ДопустимыеСтатусыВводаНаОсновании(ИмяДокумента = "", КВозврату = Ложь) Экспорт
...
//
// Параметры:
//  Объект           - ДокументОбъект.ЗаявкаНаВозвратТоваровОтКлиента - документ, в табличной части которого необходимо
...
//
// Параметры:
//  Статус - ПеречислениеСсылка.СтатусыЗаявокНаВозвратТоваровОтКлиента - текущий статус документа "Заявка на возврат
//                                                                       товаров от клиента".
//
// Возвращаемое значение:
...
Функция ПараметрыВыбораОбеспечения(Статус) Экспорт
	...
	Параметры.Вставить("ИмяТабличнойЧасти", "ЗаменяющиеТовары");
	Параметры.Вставить("СтатусКВыполнению", Статус <> Перечисления.СтатусыЗаявокНаВозвратТоваровОтКлиентов.НеСогласована
...
Функция ТекстЗапросаТаблицаЗаявкиНаВозвратТоваровОтКлиентов(Запрос, ТекстыЗапроса, Регистры)
	...
	ТекстЗапроса =
		...
		|						ЗНАЧЕНИЕ(Перечисление.СтатусыЗаявокНаВозвратТоваровОтКлиентов.Выполнена),
		|						ЗНАЧЕНИЕ(Перечисление.СтатусыЗаявокНаВозвратТоваровОтКлиентов.Отклонена))
		|	И &ХозяйственнаяОперация <> ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ВозвратОтХранителя)
		|
		|ОБЪЕДИНИТЬ ВСЕ
		|
		|ВЫБРАТЬ
...
Процедура ЗаполнитьТабличныйДокументЗаявкиНаВозврат(ТабличныйДокумент, Запрос, ОбъектыПечати)
	...
	Пока ДанныеПечати.Следующий() Цикл
		...
		Если ЕстьТоварыНаЗамену Тогда
			...
			ПараметрыВывода.Вставить("ЗаголовокСкидки", ЗаголовокСкидки);
