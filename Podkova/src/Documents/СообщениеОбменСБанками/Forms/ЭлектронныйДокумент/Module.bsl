...
Процедура ИзменитьВидимостьДоступность()
	...
	Если Объект.Направление = Перечисления.НаправленияЭД.Исходящий Тогда
		...
		Если НЕ ЭтоСлужебныйДокумент(Объект.ВидЭД) Тогда
			КоличествоНеустановленныхПодписей = КоличествоНеустановленныхПодписей(Объект.Ссылка, Объект.НастройкаОбмена, Объект.ВидЭД);
...
Функция КоличествоНеустановленныхПодписей(Знач СообщениеОбмена, Знач НастройкаОбмена, Знач ВидЭД)
	...
	ЭлектронноеВзаимодействиеСлужебный.ТаблицаМаршрутаПоПараметрам(
