...
Процедура УправлениеЭлементамиФормыНаКлиенте()
	...
	Если ЭтоРасходы Тогда
		...
		Элементы.РасходыПредставлениеОтраженияВРеглУчете.Видимость = Не РеклассификацияРасходов И ИспользоватьРеглУчет;
	...
	Иначе
		...
		Элементы.ДоходыПредставлениеОтраженияВРеглУчете.Видимость = Не РеклассификацияДоходов И ИспользоватьРеглУчет;
