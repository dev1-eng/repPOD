...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	РасходыКРаспределению.ТекстЗапроса = Документы.РаспределениеРасходовБудущихПериодов.ТекстЗапросаРасходыКРаспределению();
	...
	Элементы.РасходыКРаспределениюВременнаяРазница.Видимость = ВедетсяУчетПостоянныхИВременныхРазниц;
...
Процедура СоздатьРаспределениеРасходов(Команда)
	...
	Если Строка <> Неопределено Тогда
		...
		СтруктураОснование.Вставить("Период", Строка.Период);
...
Процедура УстановитьПараметрыДинамическихСписков()
	...
	РасходыКРаспределению.Параметры.УстановитьЗначениеПараметра("Подразделение", Неопределено);
	РасходыКРаспределению.Параметры.УстановитьЗначениеПараметра("ПоВсемПодразделениям", Истина);
