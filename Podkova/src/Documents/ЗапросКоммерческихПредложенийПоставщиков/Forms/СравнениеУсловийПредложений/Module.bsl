...
Процедура СформироватьТаблицуСравнения()
	...
	ЭлектронноеВзаимодействиеСлужебный.ВывестиОбластьВТабличныйДокумент(Документ, ШапкаНоменклатура, "Шапка|Номенклатура");
	...
	Для Каждого Источник Из СписокПредложений Цикл 
		...
		ЭлектронноеВзаимодействиеСлужебный.ПрисоединитьОбластьКТабличномуДокументу(Документ, ШапкаПредложение, "Шапка|Предложение");
	...
	Для Каждого СтрокаТовар Из СписокТоваров Цикл
		...
		ЭлектронноеВзаимодействиеСлужебный.ВывестиОбластьВТабличныйДокумент(Документ, ГруппаНоменклатура, "Группа|Номенклатура",,1);
		...
		Для Каждого СтрокаИсточник Из СписокПредложений Цикл 
			...
			ЭлектронноеВзаимодействиеСлужебный.ПрисоединитьОбластьКТабличномуДокументу(Документ, ГруппаПредложение, "Группа|Предложение");
		...
		Для Каждого Товар Из Товары Цикл
			...
			ЭлектронноеВзаимодействиеСлужебный.ВывестиОбластьВТабличныйДокумент(Документ, СтрокаНоменклатура, "Строка|Номенклатура",,2);
			...
			Для Каждого СтрокаИсточник Из СписокПредложений Цикл 
				...
				ЭлектронноеВзаимодействиеСлужебный.ПрисоединитьОбластьКТабличномуДокументу(Документ, СтрокаПредложение, "Строка|Предложение");
	...
	ЭлектронноеВзаимодействиеСлужебный.ВывестиОбластьВТабличныйДокумент(Документ, СтрокаУсловияНоменклатура, "Итого|Номенклатура");
	...
	Для Каждого СтрокаИсточник Из СписокПредложений Цикл 
		...
		Если Не СтрокаИсточник.Использовать
			...
			ЭлектронноеВзаимодействиеСлужебный.ПрисоединитьОбластьКТабличномуДокументу(Документ, СтрокаУсловияПредложение, "Итого|Предложение");
