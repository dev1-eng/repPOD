...
Функция СформироватьСправкуОПодтверждающихДокументах(МассивОбъектов, ОбъектыПечати)
	...
	|	ДанныеДокумента.Страна                    КАК Страна,
	|	ДанныеДокумента.ПризнакКорректировки      КАК ПризнакКорректировки,
	...
	Пока ВыборкаДокументы.Следующий() Цикл
		...
		Пока ВыборкаПоСтрокам.Следующий() Цикл
			...
			КонецЕсли;
			Если ВыборкаПоСтрокам.ПризнакКорректировки Тогда
				ОбластьМакета.Параметры.Корректировка = "*";
			КонецЕсли;
