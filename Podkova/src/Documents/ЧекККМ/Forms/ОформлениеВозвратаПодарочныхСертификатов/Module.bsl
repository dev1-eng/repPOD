...
Процедура ЗаполнитьТаблицуТоваров()
	...
	|	
	|	ПодарочныеСертификаты.ПодарочныйСертификат              КАК ПодарочныйСертификат,
	|	ИсторияПодарочныхСертификатовСрезПоследних.Статус       КАК СтатусПодарочногоСертификата,
	|	ПодарочныеСертификаты.Сумма             КАК Сумма
	|ИЗ
	...
	|		
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ИсторияПодарочныхСертификатов.СрезПоследних(&ТекущаяДата, ) КАК ИсторияПодарочныхСертификатовСрезПоследних
	...
	КонецЕсли;
	Запрос.Параметры.Вставить("ТекущаяДата", КонецДня(ТекущаяДатаСеанса()));
	...
	Пока Выборка.Следующий() Цикл
		...
		Если Выборка.СтатусПодарочногоСертификата <> Перечисления.СтатусыПодарочныхСертификатов.Активирован Тогда
			Продолжить;
		КонецЕсли;
