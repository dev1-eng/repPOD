...
Процедура ЗаполнитьПризнакСводныйКорректировочный() Экспорт
	...
	Если Корректировочный Тогда
		ТаблицаОснований = ДокументыОснования.Выгрузить(,"ДокументОснование,ИсходныйДокумент");
		ТаблицаОснований.Свернуть("ДокументОснование,ИсходныйДокумент");
		СводныйКорректировочный = ТаблицаОснований.Количество() > 1;
	Иначе
...
#Область КорректировкаПриобретения
	...
	Если ЕстьКорректировки И Не Корректировочный Тогда
...
Функция ПолучитьПараметрыСчетаФактурыПоОснованиям(МассивДокументовОснований)
	...
	Запрос.УстановитьПараметр("ДанныеОснований", ПолучитьДанныеОснований(МассивДокументовОснований));
...
Функция ПолучитьДанныеОснований(МассивДокументовОснований)
	...
	Для Каждого Основание Из МассивДокументовОснований Цикл
		...
		// При эмулировании механизма проведения документа для получения данных оснований необходимо устанавливать привилегированный режим.
		
		УстановитьПривилегированныйРежим(Истина);
		МенеджерДокумента.ИнициализироватьДанныеДокумента(Основание, ДополнительныеСвойстваОснования, "ЗаполнениеШапкиСФПолученный");
		УстановитьПривилегированныйРежим(Ложь);
		
		ОбщегоНазначенияКлиентСервер.ДополнитьТаблицу(ДополнительныеСвойстваОснования.ТаблицыДляДвижений.ТаблицаЗаполнениеШапкиСФПолученный,
			ДанныеОснований);
	КонецЦикла;
