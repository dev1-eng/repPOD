...
Процедура Заполнить(Команда)
	...
	ИначеЕсли (Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.ВидыОперацийКорректировкиНазначения.СнятьРезерв")
		...
		ТекстПредупреждения = НСтр("ru = 'По данному назначению нет потребностей. Заполнение возможно только через операцию ""Произвольная корректировка""'");
...
Процедура УстановитьВидимостьДоступность()
	...
	Элементы.ТоварыДобавить.Видимость            = ЭтоПроизвольнаяКорректировка;
	...
	Элементы.ТоварыНазначениеМассовоеСнятие.Видимость = ЭтоМассовоеСнятие И Не Объект.ДокументПоРаспоряжению И МогутБытьНазначенияБезЗаказа;
	Элементы.ТоварыЗаказ.Видимость                    = ЭтоМассовоеСнятие И Не Объект.ДокументПоРаспоряжению И Не МогутБытьНазначенияБезЗаказа;
	...
	ОтображатьНазначениеШапки = (ЭтоРезервирование Или ЭтоСнятиеРезерва Или ЭтоКорректировка)
								 И МогутБытьНазначенияБезЗаказа;
