...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	Если ТипЗнч(ДанныеЗаполнения) = Тип("Структура") Тогда
		...
		Если ДанныеЗаполнения.Свойство("ХозяйственнаяОперация", ХозяйственнаяОперация) Тогда
			ПриходоватьТоварыПоСебестоимостиСписания = ЗначениеЗаполнено(ХозяйственнаяОперация)
														И ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ПорчаТоваров;
		КонецЕсли;
...
Процедура ЗаполнитьРеквизитыУчетаДоходовРасходов()
	...
	|	И ПорчаТоваров.Ответственный = &Ответственный
	|	И ПорчаТоваров.ПриходоватьТоварыПоСебестоимостиСписания = &ПриходоватьТоварыПоСебестоимостиСписания
	|
	|УПОРЯДОЧИТЬ ПО
