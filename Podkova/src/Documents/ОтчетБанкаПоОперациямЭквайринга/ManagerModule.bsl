...
Функция ТекстЗапросаТаблицаВтИсходныеПрочиеРасходы(Запрос, ТекстыЗапроса) Экспорт
	...
	Если Не ПроведениеСерверУТ.ЕстьТаблицаЗапроса("ВТСуммыДокументовВВалютеРегл", ТекстыЗапроса) Тогда
		ТекстЗапросаВТСуммыДокументовВВалютеРегл(Запрос, ТекстыЗапроса);
	КонецЕсли;
	...
	|ИЗ
	|	Документ.ОтчетБанкаПоОперациямЭквайринга КАК ДанныеДокумента
	|	ЛЕВОЕ СОЕДИНЕНИЕ ВТСуммыДокументовВВалютеРегл КАК СуммыДокументовВВалютеРегл
	|		ПО ИСТИНА
	|ГДЕ
	|	ДанныеДокумента.Ссылка = &Ссылка
	|	И ДанныеДокумента.СуммаКомиссии <> 0
...
Функция ТекстЗапросаВТСуммыДокументовВВалютеРегл(Запрос, ТекстыЗапроса)
	
	ИмяРегистра = "ВТСуммыДокументовВВалютеРегл";
...
Функция ТекстЗапросаСуммыДокументовВВалютеРегл(Запрос, ТекстыЗапроса, Регистры)
	...
	|	*
	|ИЗ
	|	ВТСуммыДокументовВВалютеРегл КАК Т
	|";
