...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Отбор.Свойство("ДатаДокумента", ДатаДокумента) Тогда
		...
		ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(
			...
			, 
			ЗначениеЗаполнено(ДатаДокумента));
	...
	Если Параметры.Отбор.Свойство("Организация", ПараметрОрганизация) Тогда
