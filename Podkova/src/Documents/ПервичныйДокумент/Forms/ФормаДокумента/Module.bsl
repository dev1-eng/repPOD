...
Процедура ПослеЗаписиНаСервере(ТекущийОбъект, ПараметрыЗаписи)
	...
	ВидЦенностиВводОстатков = РегистрыСведений.ПодтверждениеОплатыНДСВБюджет.ВидЦенностиВводОстатков(Объект.Ссылка);
...
Процедура СуммаДокументаПриИзменении(Элемент)
	 ...
	 Объект.СуммаРегл = ЗаполнитьСуммыРеглСервер(Объект.СуммаДокумента, ВалютаРегламентированногоУчета, Объект.Валюта, Объект.Дата);
...
Функция ЗаполнитьСуммыРеглСервер(СуммаДокумента, ВалютаРег, Валюта, Дата)
	
	СуммаРегл = РаботаСКурсамиВалют.ПересчитатьВВалюту(
							СуммаДокумента, Валюта, ВалютаРег, Дата);
