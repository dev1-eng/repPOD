...
// * ДальнейшееДействие1 - ПеречислениеСсылка.ДальнейшиеДействияПоВзаимодействиюИСМП,
//   ПеречислениеСсылка.ДальнейшиеДействияПоВзаимодействиюЕГАИС,
//   ПеречислениеСсылка.ДальнейшиеДействияПоВзаимодействиюВЕТИС, Массив - Дальнейшее действие 1.
...
// * Статус - ПеречислениеСсылка - подробнее См. МенеджерОбъекта.СтатусПоУмолчанию().
// * Документ - ДокументСсылка - Ссылка на оформляемый документ.
//
