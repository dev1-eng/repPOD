...
Функция КодФСРАРИзУТМНаСервере(НастройкаОбмена)
	...
	РезультатПолученияКодаФСРАР = ИнтеграцияЕГАИСКлиентСервер.КодФСРАРv3(НастройкаОбмена);
	Если РезультатПолученияКодаФСРАР.ПроверитьУТМv4 Тогда
		РезультатПолученияКодаФСРАР = ИнтеграцияЕГАИСКлиентСервер.КодФСРАРv4(НастройкаОбмена);
	КонецЕсли;
