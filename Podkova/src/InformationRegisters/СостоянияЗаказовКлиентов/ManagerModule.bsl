...
Функция ТекстЗапросаДляРасчетаСостоянийОбеспеченияЗаказа()
	...
	ТекстЗапроса = "
		...
		|ПОМЕСТИТЬ ВТСводТоваровПоЗаказамКлиентов
		|ИЗ
		...
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
		|	ЗаменяющиеТовары.Ссылка КАК Ссылка,
		|	ЗаменяющиеТовары.Номенклатура КАК Номенклатура,
		|	ЗаменяющиеТовары.Характеристика КАК Характеристика,
		|	ЗаменяющиеТовары.Ссылка.Склад КАК Склад,
		|	ЗаменяющиеТовары.ВариантОбеспечения КАК ВариантОбеспечения,
		|	СУММА(ЗаменяющиеТовары.Количество) КАК Количество
		|ПОМЕСТИТЬ ВТСводТоваровПоЗаявкамНаВозвратТоваровОтКлиента
		|ИЗ
		...
		|	ЗаменяющиеТовары.Ссылка.Склад,
		|	ЗаменяющиеТовары.ВариантОбеспечения
		|;
		|
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
		...
		|ИЗ
		|	ВТСводТоваровПоЗаказамКлиентов КАК ЗаказКлиентаТовары
		...
		|		КОНЕЦ)
		|ИЗ
		|	ВТСводТоваровПоЗаявкамНаВозвратТоваровОтКлиента КАК ЗаменяющиеТовары
		|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрНакопления.ОбеспечениеЗаказов.Остатки(, Назначение.Заказ В (&МассивЗаказов)) КАК ОбеспечениеЗаказовОстатки
