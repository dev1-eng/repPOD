...
Функция РезультатОбновленияДанныхИзСервисаПоОрганизации(Организация) Экспорт
...
Функция РезультатПолученияДанныхИзСервисаПоОрганизации(Организация) Экспорт
...
//
Функция РезультатОбновленияДанныхИзСервисаПоОрганизацииЗаДень(Организация, Дата, ДатаОбновления) Экспорт
...
//
Функция НовыйРезультатОбновления() Экспорт
