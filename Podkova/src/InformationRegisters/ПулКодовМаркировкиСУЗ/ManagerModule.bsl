...
Функция ДанныеКодовМаркировки(КодыМаркировки) Экспорт
	...
	|ГДЕ
	|	// Коды, сохраненные в пуле для печати чека не должны учитываться
	|	// при заполнении данных по кодам в механизме штрихкодирования
	|	ПулКодовМаркировкиСУЗ.ДатаЭмиссииУниверсальная > ДатаВремя(1,1,1)
	|");
...
Функция КодыМаркировкиПоОснованию(Основания, Напечатанные = Неопределено) Экспорт
	...
	Запрос.Текст =
		...
		|	Представление(ПулКодовМаркировкиСУЗ.ШтрихкодУпаковки) КАК КодМаркировкиУпаковки,
		|	ПулКодовМаркировкиСУЗ.ШтрихкодУпаковки                КАК ШтрихкодУпаковки
		|ИЗ
		|	РегистрСведений.ПулКодовМаркировкиСУЗ КАК ПулКодовМаркировкиСУЗ
		|ГДЕ
