...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЕстьОбменСКонтрагентами Тогда
		...
		МассивВнутреннихДокументов = МодульОбменСКонтрагентамиСлужебный.ВидыВнутреннихЭлектронныхДокументов();
		ОбщегоНазначенияКлиентСервер.ДополнитьМассив(АктуальныеЭД, МассивВнутреннихДокументов, Истина);
	КонецЕсли;
...
Процедура ОповеститьОбИзмененииФлаговИспользовать(ВидыЭД) 
	...
	Если ОбщегоНазначенияКлиент.ПодсистемаСуществует("ЭлектронноеВзаимодействие.ОбменСКонтрагентами") Тогда
		МодульПодсистемы = ОбщегоНазначенияКлиент.ОбщийМодуль("ОбменСКонтрагентамиДиагностикаКлиентСервер");
		ВидОшибки = МодульПодсистемы.ВидОшибкиДляСертификатаНетПодписываемогоВидаДокумента();
