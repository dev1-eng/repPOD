...
// Получает настройку поставщика по органзиции из сервиса
// 
// Параметры:
...
// * КонтрагентЗарегистрирован - Булево - признак того, что контрагент зарегистирован в Бизнес-сети.
//
...
// Получает настройку поставщика по органзиции локально.
// 
// Параметры:
// 	Организация - ОпределяемыйТип.ОрганизацияEDI - организация, по которой надо получить настройку.
// 	Контрагент  - ОпределяемыйТип.КонтрагентEDI - поставщик.
...
// 
// Параметры:
// 	Поставщик - ОпределяемыйТип.ОрганизацияEDIг - организация, для которой получаются настройки.
// Возвращаемое значение:
...
// Конструктор параметров офрмления заказов покупателями.
// 
// Возвращаемое значение:
...
Функция РежимПриемаЗаказовПоПокупателюИПоставщику(Поставщик, Покупатель) Экспорт
	
	ПараметрыПриемаЗаказовПоставщикомОтПокупателя = НастройкиПриемаЗаказовПоставщикомОтПокупателя(Поставщик, Покупатель);
	Возврат РежимПриемаЗаказовПоставщикомОтПокупателя(ПараметрыПриемаЗаказовПоставщикомОтПокупателя);
...
// Выполняет обновление настроек по переданным организациям из сервиса и сохраняет данные о выполненом обновлении.
// 
// Параметры:
...
Функция РезультатОбновленияНастроекОрганизацииИзСервиса(Организация) Экспорт
	...
	РезультатПолученияНастроек = РегистрыСведений.НастройкиИнтеграцииEDI.РезультатПолученияИСохраненияНастроекОрганизацииВСервисе(Организация);
	
	Если Не РезультатПолученияНастроек.Успешно Тогда
		Результат.Успешно     = Ложь;
		Результат.ТекстОшибки = РезультатПолученияНастроек.ТекстОшибки;
	КонецЕсли;
...
Функция РезультатОбновленияНастроекКонтрагентовПоОрганизации(Организация) Экспорт
