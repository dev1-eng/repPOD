...
// * Организация             - ОпределяемыйТип.ОрганизацияEDI - огранизация.
...
// Получает настройки организации из сервиса и сохраняет в информационной базе.
// 
// Параметры:
// 	Организация - ОпределяемыйТип.ОрганизацияEDI - организация, для которой получается префикс.
// Возвращаемое значение:
...
Функция РезультатПолученияИСохраненияНастроекОрганизацииВСервисе(Организация) Экспорт
	...
	Если Не РезультатПолучения.Ошибка Тогда
		...
		ЗаписьНабора.ОтветственныйПоУмолчаниюДляНовыхЗаказовКлиента = РезультатПолучения.Данные.ОтвественныйЗаНовыеЗаказыКлиентовПоУмолчанию;
